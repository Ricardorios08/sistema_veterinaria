<html>
<head>
<title>Mensajes de confirmación</title>


<p align="center"><b>Mensajes de confirmación
...
<!--  Begin
function askData() {
var inputedData =  prompt ("Escribe algo:", "" );
if (confirm("¿Seguro que escribiste "+inputedData+"?")) {
alert ("¡Ah, pues sí, escribiste "+inputedData+"!");
}
else {
alert ("No, tú no escribiste "+inputedData+", ¿o sí? ¡Yo creo que sí.");
   }   
}
// End -->
</script>
