...
<frameset rows="145,*" cols="*" frameborder="no" border="0" framespacing="0">
  <frame src="drivers/frames/frame_arriba_tecnica.php?usuario=<?php print("$usuario");?>" name="arriba" scrolling="No" noresize="noresize" id="arriba" title="arriba" />
  

<FRAMESET cols="167,857,20%">
