...
<div id="masthead">
  ...
  <div id="globalNav"> <img alt="" src="gblnav_left.gif" height="32" width="4" id="gnl" /> <img alt="" src="glbnav_right.gif" height="32" width="4" id="gnr" />
	...
	<a href='../a_sectores/contaduria/plan_cuentas.php' target = 'izquierda' id="gl5" class="glink" onmouseover="ehandler(event,menuitem5);">PLAN DE CUENTAS </a>
	...
	<a href='../a_sectores/contaduria/caja.php' target = 'izquierda' id="gl7" class="glink" onmouseover="ehandler(event,menuitem7);">CAJA</a></div>
