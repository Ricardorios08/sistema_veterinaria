...
<table width="750" height="115" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#993300">
    <td colspan="7" bgcolor="#E1F2EF"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif">LISTADO DE EXISTENCIA POR FABRICANTE. Emitido el <?php echo $hoy;?> </font></div></td>
  </tr>
  <tr bordercolor="#FFFFCC" bgcolor="#993300">
...
$sql1="select * from mercaderia where cod_merca like '$cod_fabricante%' order by cod_merca";
