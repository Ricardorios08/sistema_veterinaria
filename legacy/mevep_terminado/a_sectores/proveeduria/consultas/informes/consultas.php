...
<table width="860" border="0" cellspacing="0">
  <tr>
    <td colspan="2" align="center" bgcolor="#000099" scope="row"><div align="center"><span class="Estilo13">CONSULTAS EXISTENCIA: <?php echo $opciones;?></span></div></td>
  </tr>
  <tr>
    ...
    <td width="64%" align="center" bgcolor="#E1F2EF" scope="row"><div align="left">
        <input type = "text" name = "busca" size = "20" value = "<?php echo $cod_merca;?>">
