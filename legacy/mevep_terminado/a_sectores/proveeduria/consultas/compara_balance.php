...
<table width="130%" height="131" border="0">
  ...
  <tr bordercolor="#FFFFCC" bgcolor="#FFFFFF">
    ...
    <td colspan="7" valign="top"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif">LISTADO DE EXISTENCIA. Emitido el <?echo $hoy;?> </font></div></td>
  </tr>
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#000099">
    ...
    <td width="85" height="23" bgcolor="#FFFFFF"><div align="center"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">CODIGO</font></div></td>
    <td width="239" bgcolor="#FFFFFF"><div align="center"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">PRODUCTO</font></div></td>
<td width="93" bgcolor="#FFFFFF"><div align="center"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">LOTE</font></div></td>
...
<td width="76" bgcolor="#FFFFFF"><div align="center"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">SALIDAS</font></div></td>
<td width="75" bgcolor="#FFFFFF"><div align="center"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">SALDO</font></div></td>
<td width="103" bgcolor="#FFFFFF"><div align="center"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">DEBE </font></div></td>

  <td width="64" bgcolor="#FFFFFF"><div align="center"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">HABER </font></div></td>
  <td width="79" bgcolor="#FFFFFF"><div align="center"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">SALDO</font></div></td>
  </tr>
...
// $sql1="select * from existencias where fecha_ultimo_mov = '$hoy' order by cod_mercaderia";
  $sql1="select * from existencias_270809 order by cod_mercaderia";
$result1 = $db_in->Execute($sql1);
 
  if (!$result1) die("fallo".$db_in->ErrorMsg());
  while (!$result1->EOF) {
...
$cod_movimiento=strtoupper($result1->fields["fecha_ultimo_mov"]);



$sql5="select sum(cantidad) as inventario from stock_270809 where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio_lote' and  cod_movimiento = 1";
$result5 = $db_in->Execute($sql5);
$inventario=strtoupper($result5->fields["inventario"]);

$sql5="select sum(cantidad) as compras from stock_270809 where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio' and cod_movimiento = 2";
$result5 = $db_in->Execute($sql5);
$compras=strtoupper($result5->fields["compras"]);

$sql5="select sum(cantidad) as nc from stock_270809 where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio' and cod_movimiento = 3";
$result5 = $db_in->Execute($sql5);
$nc=strtoupper($result5->fields["nc"]);

$sql5="select sum(cantidad) as ajp from stock_270809 where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio' and cod_movimiento = 4";
$result5 = $db_in->Execute($sql5);
$ajp=strtoupper($result5->fields["ajp"]);

$sql5="select sum(cantidad) as ventas from stock_270809 where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio' and cod_movimiento = 5";
$result5 = $db_in->Execute($sql5);
$ventas=strtoupper($result5->fields["ventas"]);

$sql5="select sum(cantidad) as ajn from stock_270809 where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio' and cod_movimiento = 7";
$result5 = $db_in->Execute($sql5);
...
?>
    ...
    <td><div align="left"><font size="2"><?print("$descripcion");?></font></div></td>
...
//echo $sql3 = "UPDATE `stock` SET `mes_lote` = '$mes_lote', `anio_lote` = '$anio_lote' WHERE lote = '$lote' and cod_mercaderia = $cod_mercaderia and cod_movimiento = 3";
