...
<table width="650" border="0">
  <tr>
    <td colspan="2" align="center" bgcolor="#000099" scope="row"><div align="center"><span class="Estilo13">ANALISIS DE FACTURAS DE: <?php echo $denominacion;?></span></div></td>
  </tr>
<!--   <tr bgcolor="#E1F2EF">
  ...
  <tr bgcolor="#E1F2EF">
    ...
    <td align="center" scope="row"><div align="left">
      <input type = "text" name = "busca" size = "7" value = "<?php echo $cuenta;?>">
    </div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
