...
?>
<table width="83%" height="58" border="4">
...
?>
  <tr> 
    <td><font color="#FF0000" size="2"><?print("$id");?></font></td>
    <td><font color="#0000FF" size="2"><?print("$nombre");?></font></td>
    <td><font size="2"><?print("$cantidad1");?></font></td>
    <td><font size="2"><?print("$precio_unitario1");?></font></td>
    <td><font size="2"><?print("$lote1");?></font></td>
    <td><font size="2"><?print("$vto_lote1");?></font></td>
    <td><font color="#FF0000" size="2"><?print("$denominacion");?></font></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="proveeduria\mercaderia\modificar_ficha.php?id=<?print("$id");?>" target = "central">[OK]</a></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="../../proveeduria/mercaderia/borra_ficha.php?id=<?print("$id");?>">[OK]</a> </font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="../mercaderia/ficha.php?id=<?print("$id");?>">[OK]</a></font></div></td>
    </tr>
  <?
