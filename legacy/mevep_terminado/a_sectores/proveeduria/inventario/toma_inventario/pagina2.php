...
<table width="650" border="0">
  <tr bgcolor="#808080">
    <td width="33%" height="27"><div align="center"><strong><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><font color="#FFFFFF">MERCADERIA</font> </font> </strong></div></td>
    ...
    <td width="27%" height="27" colspan="2"><div align="right"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><?php echo $fecha1;?></font></strong></div></td>
  </tr>
  <tr bgcolor="#A0A7F5">
...
$sql2 = "SELECT * FROM `existencias_nuevo` where cod_mercaderia = '$cod_mercaderia'";
$result2 = $db->Execute($sql2);
$cod_merca=strtoupper($result2->fields["cod_mercaderia"]);

if ($cod_merca == ""){
echo  $sql = "INSERT INTO `existencias_nuevo` ( `nro_factura` , `cod_detalle` , `cod_mercaderia` , `lote` ,  `mes_lote` , `anio_lote` , `cantidad_ingresada` , `precio_unitario` , `cantidad_salida` , `fecha_ultimo_mov` )  VALUES ('1' , '' ,'$cod_mercaderia' , '' , '' , '', '$cantidad' , '' , '' , '$fecha_ultimo_mov')";
mysql_query($sql);
}
else{
...
if ($cod_merca2 == ""){
$leyenda = "MERCADERIA EXISTENTE O NO INGRESO NADA";
include ("../../../../alertas/campo_informacion.php");
}ELSE{
