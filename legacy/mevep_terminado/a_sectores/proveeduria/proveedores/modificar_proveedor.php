...
<table width="860" border="0">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
      ...
      <td width="64%" colspan="2"><input type="text" name="cuenta" id="cuenta" value = "<?php echo $cuenta;?>" onKeyPress="return verif_caracter(this,event)" size="5" >        
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
      ...
      <td colspan="2"><input name="denominacion" type="text" id="denominacion" onKeyPress="return verif_caracter(this,event)" value="<?php echo $denominacion;?>"  size="25"> 
      </td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
      ...
      <td colspan="2"><input name="contacto" type="text" id="contacto" onKeyPress="return verif_caracter(this,event)" value="<?php echo $contacto;?>"  size="25">        </td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
      <td bgcolor="#D0F9FB"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Calle</font></div></td>
      <td colspan="2"><input name="domicilio" type="text"  id="domicilio" onKeyPress="return verif_caracter(this,event)" value="<?php echo $domicilio;?>"  size="25">
      <font size="2" face="Arial, Helvetica, sans-serif">Nro</font> <input name="puerta" type="text" id="puerta"onKeyPress="return verif_caracter(this,event)" value="<?php echo $puerta;?>"  size="4"></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
      <td bgcolor="#D0F9FB"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Referencia</font></div></td>
      <td><input name="referencia" type="text" id="referencia"onKeyPress="return verif_caracter(this,event)" value="<?php echo $referencia;?>"  size="35"></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
 ...
 <optgroup label="Capital">
      ...
      <font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Codigo Postal 
        <input name="cod_postal" type="text" id ="cod_postal" onKeyPress="return verif_caracter(this,event)" value="<?php echo $cuenta;?>" size="5">
</font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
      <td bgcolor="#D0F9FB"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Telefono(1)</font></div></td>
      <td colspan="2"><input name="caracteristica_1" type="text" id="caracteristica_1" onKeyPress="return verif_caracter(this,event)" value="<?php echo $caracteristica_1;?>" size="7">
        <input name="telefono_1" type="text" id="telefono_1" onKeyPress="return verif_caracter(this,event)" value="<?php echo $telefono_1;?>" size="15">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF"> 
      ...
      <td colspan="2">        <input name="caracteristica_2" type="text" id="caracteristica_2" onKeyPress="return verif_caracter(this,event)" value="<?php echo $caracteristica_2;?>" size="7">       
 <input name="telefono_2" type="text" id="telefono_2" onKeyPress="return verif_caracter(this,event)" value="<?php echo $telefono_2;?>" size="15">
 <font size="2" face="Arial, Helvetica, sans-serif">(Fijo) </font> <div align="right"></div>                  </td>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
      ...
      <td colspan="2"><input name="caracteristica_3" type="text" id="caracteristica_3" onKeyPress="return verif_caracter(this,event)" value="<?php echo $caracteristica_3;?>" size="7">   
     <input name="telefono_3" type="text" id="telefono_3" onKeyPress="return verif_caracter(this,event)" value="<?php echo $telefono_3;?>" size="15">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
      ...
      <td colspan="2"><input name="email" type="text" id="email" onKeyPress="return verif_caracter(this,event)" value="<?php echo $email;?>" size="30">      </td>
    </tr>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
      ...
      <td colspan="2"><strong>
        ...
        <select name="tipo_iva[]" tabindex="13"id="tipo_iva"onkeypress="return verif_caracter(this,event)">
         <optgroup label="Opcion Seleccionada">
			<option value selected= "<?php "$tipo_iva";?>"> <?php print("$tipo_iva");?></option>
	</optgroup>
 <optgroup label="Cambiar por:">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
      ...
      <td colspan="2">
        <select name="ing_bruto[]" id="ing_bruto" onkeypress="return verif_caracter(this,event)">
          <optgroup label="Opcion Seleccionada">
			<option value selected= "<?php "$ing_bruto";?>"> <?php print("$ing_bruto");?></option>
	</optgroup>
 <optgroup label="Cambiar por:">
<option value = "1">Normal</option>
        ...
        <input name="pago_orden2" type="text" id="pago_orden3" onKeyPress="return verif_caracter(this,event)" value="<?php echo $nro_ib;?>" size = "25">
        </strong> </td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
      ...
      <td colspan="2"><strong>
        <input name="pago_orden" type="text" id="pago_orden" onKeyPress="return verif_caracter(this,event)" value="<?php echo $pago_orden;?>" size = "25">
      </strong></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#E1F2EF">
      <td bgcolor="#D0F9FB"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Observaciones</font></div></td>
      <td colspan="2"><strong>
        <input name="observaciones" type="text" id="observaciones" onKeyPress="return verif_caracter(this,event)" value="<?php echo $observaciones;?>" size = "25">
      </strong></td>
    </tr>
