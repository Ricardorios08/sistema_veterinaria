...
$plan;
if ($plan == ""){
$sql = "SELECT * FROM `ventas1_encab_temp`  WHERE  `nro_factura` = $nro_factura and tipo_fact = '$tipo_fact'";
...
$sql = "UPDATE `ventas1_encab_temp` SET `forma_pago` = '$forma_pago' WHERE nro_factura = $nro_factura  and tipo_fact = '$tipo_fact'";
mysql_query($sql);
...
$cant_ingr_exi = $result1->fields["cantidad_ingresada"];
$cant_salid_exi = $result1->fields["cantidad_salida"];

if ($cant_ingr_exi == $cant_salid_exi){
