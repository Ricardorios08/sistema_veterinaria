...
<?php if ($band != "SI"){
	...
	$nro_proveedo=$_POST["nro_proveedor"];
	for ($i=0;$i<count($nro_proveedo);$i++)    
	{     
	$nro_proveedor = $nro_proveedo[$i];    
	}
...
<table width="860" border="0">
  <tr bgcolor="#000099">
    <td width="56%" height="27" colspan="2" bgcolor="#666666"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"> INGRESAR COMPRAS</font> </div></td>
    <td width="30%" height="27" colspan="2" bgcolor="#666666"><div align="right"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><font size="2">Operador:</font> <font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><?php echo $nombre_operador;?></font></font></div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
    <td colspan="4" bgcolor="#EDEDED"><div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"> Proveedor: </font>        <font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"> <?php echo $denominacion;?> (<?php echo $nro_proveedor;?>) &nbsp;&nbsp;&nbsp;&nbsp;</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif">Fecha/Compra: </font><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><?php echo $fecha1;?> &nbsp;&nbsp;&nbsp;&nbsp;</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif">N&ordm; Comprobante:</font> <font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><?php echo $nro_factura;?> &nbsp;&nbsp;&nbsp;&nbsp;</font><font size="2" face="Arial, Helvetica, sans-serif"> </font></div></td>
  </tr>
  <tr bgcolor="#E8DCFC">
    <td colspan="4" bgcolor="#EDEDED"><div align="left"></div>      
      <div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">N&ordm; Mercaderia: <strong><font color="#006600">
        <input type = "text" name = "cod_mercaderia" id="cod_mercaderia" size = "40" onKeyPress="return verif_caracter(this,event)">
