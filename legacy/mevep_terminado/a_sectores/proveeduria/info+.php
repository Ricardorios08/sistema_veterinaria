...
<table width="166"  border="0">
  ...
  <tr>
    <td bgcolor="#666666"><div align="center" class="titulo">INFO + </div></td>
  </tr>
</table>
<div id="menuv">
		<ul>
			...
			<li><a href="../facturacion/socios_ruta1.php" target = "central" >Listado SOCIOS</a></li>

			<li><a href="../facturacion/socios_ruta1_part.php" target = "central" >Listado PARTICULARES</a></li>
...
<!-- <li><a href="consultas/informes/consultas.php?opciones=Lista de Precios" target = "central" > LISTA DE PRECIOS</a></li> -->
            ...
            <li><a href="../facturacion/hc.php" target = "central" >HC</a></li> 
		  </ul>
		</ul>
</div>
