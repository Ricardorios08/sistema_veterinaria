...
//$nError = IF_WRITE("@TIQUEABRE|C|");
 ...
 $nError = IF_WRITE("@FACTABRE|T|C|A|1|P|10|I|I|".$denominacion_particular_A."||CUIT|".$cuit_particular."|N|".$domicilio_particular."|".$localidad_particular);
...
//$nError = IF_WRITE("@FACTPAGO|DESCUENTO ".$descuento."|".$desc."|D");
  $nError = IF_WRITE("@FACTPAGO|PAGO|".$total."|T");
