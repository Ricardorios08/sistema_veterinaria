...
$nError = IF_WRITE("@PONEENCABEZADO|2|TIQUE FACTURA B / CONSUMIDOR FINAL ");
...
$nError = IF_WRITE("@TIQUEITEM|".$descripcion."|    ".$cantidad."|      ".$precio_socio1."|21.00|M|1|0|0|");
...
//$nError = IF_WRITE("@FACTPAGO|DESCUENTO ".$descuento."|".$desc."|D");
  $nError = IF_WRITE("@TIQUEPAGO|PAGO|".$total_soc."|T");
