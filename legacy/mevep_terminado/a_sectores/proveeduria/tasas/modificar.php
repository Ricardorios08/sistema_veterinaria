      ...
      <table width="100%" border="0">
        ...
        <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE">
          ...
          <td bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
            <input type="text" name="cod_tasa" id="cod_tasa" onKeyPress="return verif_caracter(this,event)" size="5" value = "<?php echo $cod_tasa;?>">
        ...
        <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE">
          <td bgcolor="#C1F2FF"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">SOCIOS</font> </div></td>
          <td bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="iva_normal" type="text" id="iva_normal" onKeyPress="return verif_caracter(this,event)" value="<?php echo $iva_normal;?>"  size="5">
          </font></td>
        </tr>
        <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
          <td bgcolor="#C1F2FF"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">PARTICULARES</font></div></td>
          <td bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="iva_recargo" type="text"  id="iva_recargo" onKeyPress="return verif_caracter(this,event)" value="<?php echo $iva_recargo;?>"  size="5">
          </font></td>
        </tr>
