  ...
  <table width="650" border="0">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE">
      ...
      <td width="48%" bgcolor="#9FE1BB"><font color="#006633" size="2" face="Arial, Helvetica, sans-serif">
        <input type="text" name="fecha" id="fecha2" onKeyPress="return verif_caracter(this,event)" size="8" value="<?php echo $hoy;?>">
      </font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE">
      ...
      <td bgcolor="#9FE1BB"><font size="2" face="Arial, Helvetica, sans-serif">
        <input type="text" name="cod_tasa" id="cod_tasa2" onKeyPress="return verif_caracter(this,event)" size="5" value = "<?php echo $cod_tasa;?>">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE">
      <td bgcolor="#A0A7F5"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Socios</font> </div></td>
      <td bgcolor="#9FE1BB"><font size="2" face="Arial, Helvetica, sans-serif">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#A0A7F5"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"> Particulares </font></div></td>
      <td bgcolor="#9FE1BB"><font size="2" face="Arial, Helvetica, sans-serif">
