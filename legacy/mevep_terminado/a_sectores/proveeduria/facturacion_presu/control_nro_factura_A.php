...
<FORM name="form" ACTION="factura_papel.php" METHOD = "POST">
  ...
  <tr bgcolor="#E6E6E6">
    <td height="32" colspan="3" ><div align="center" class="Estilo15" >
      ...
      </span></span></span>REVISAR  FACTURA E IMPRIMIR (PRESUPUESTO)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      <input type="button" value="&lt;-- Corregir" onKeyPress="history.back()" onCLICK="history.back()" id ="boton" style="font-family: Verdana; font-size: 14 pt"></div>
    </div> </td>
    </tr>
  <tr bgcolor="#C1F2FF">
  ...
  <tr bgcolor="#C1F2FF">
    <td width="38%" bgcolor="#99CCFF"><div align="right" class="Estilo17"><span class="Estilo18">En caso de no coincidir Cambiar por:
      </span></div></td>
    <td colspan="2" bgcolor="#E6E6E6"><span class="Estilo14 Estilo17">
      ...
      <input name="impri" type="image" src="../../../imagenes/botones/btn_imprimir.gif" id ="imprimir" value="IMPRI" onclick="return confirm('Si están todos los datos correctos IMPRIMA');">
</span></td>
  </tr>
  <tr bgcolor="#C1F2FF">
...
<?}?>
 ...
 <table width="95%" height="68" border="0">
      ...
      <tr bgcolor="#C4D7E6">
        ...
        <span class="Estilo7 Estilo4 Estilo11  Estilo14 Estilo16">IVA</span><span class="Estilo7 Estilo19  Estilo4 Estilo16">:</span><span class="Estilo7 Estilo4 Estilo17 Estilo14 Estilo16"> <?print("$tipo_fact");?> - Cuit: <?echo $cuit;?> </span><span class="Estilo16"></span></td>
