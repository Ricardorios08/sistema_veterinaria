...
$sql6 = "SELECT * FROM `ventas1_encab_temp_pc2`  WHERE  `nro_factura` = $nro_factura";
...
$sql3 = "SELECT * FROM `ventas1_deta_temp_pc2`  WHERE  `nro_factura` = $nro_factura order by cod_detalle desc";
...
$precio_actualizado = round($precio_actualizado,3);

$total = round($precio_actualizado * $cantidad,2); //subtotal

$sql_update = "UPDATE `ventas1_deta_temp_pc2` SET `precio_unitario` = '$precio_actualizado','`total` = '$total' WHERE `cod_detalle` = '$cod_detalle'";
...
?>
    ...
    <td scope="col"><div align="right" class="Estilo46 Estilo32"><span class="Estilo33"><?echo number_format($precio_actualizado,3);?></span></div></td>
...
<table width="103%" border="0">
    ...
    <td width="17%" scope="col"><div align="center"> <div align="center" class="Estilo82">
      <div align="center"><span class="Estilo76">Neto Grav.  $ </span> </div>
    </div></td>
    <td width="21%" scope="col"><div align="center" class="Estilo82">
