...
$sql3 = "SELECT * FROM `ventas1_deta_temp_pc2`  WHERE  `nro_factura` = $nro_factura";
...
?>
    ...
    <td scope="col"><div align="right" class="Estilo46"><span class="Estilo26">$ <?echo $precio_actualizado;?></span></div></td>
    <td scope="col"><div align="right" class="Estilo46"><span class="Estilo26">$ <?echo round($total,2);?></span></div></td>
   <td width="4%" bgcolor="#E0EDF3" class="Estilo6"><div align="center">
   <a href="borrar_item.php?cod_detalle=<?print("$cod_detalle");?>&&tipo_fact=<?print("$tipo_fact");?>&&nro_factura=<?print("$nro_factura");?>&&nro_cliente=<?print("$nro_cliente");?>&&matricula=<?print("$matricula");?>&&pasada=1&&forma_pago=<?print("$forma_pago");?>&&dia=<?print("$dia");?>&&mes=<?print("$mes");?>&&anio=<?print("$año");?>&&mes=<?print("$mes");?>&&band=<?print("$band");?>&&operador=<?print("$operador");?>" onclick="return confirm('¿Está seguro de borrar este producto?');"><IMG SRC="../../../imagenes/office/095.ico" alt="Anular"  border = "0"></a>
...
<table width="103%" border="0">
		  <tr bgcolor="#CFCFCF" >
    <td width="18%" height="20" scope="col"><div align="right" class="Estilo82"><span class="Estilo76">Subtotal     
    $ </span></div></td>
    <td width="19%" scope="col"><div align="right" class="Estilo82"><span class="Estilo76">Descuento $ </span></div></td>
    <td width="17%" scope="col"><div align="center"><span class="Estilo83"></span>  </div></td>
    <td width="17%" scope="col"><div align="center"><span class="Estilo83"></span> </div></td>
    <td width="29%" colspan="4" scope="col"><span class="Estilo83"><strong><strong>
      </strong>
      </span>
      <div align="right" class="Estilo83"><strong><span class="Estilo76">
         TOTAL $ </span></strong></div></td>
  </tr>
		  <tr bgcolor="#E6E6E6" >
		    <td height="20" scope="col"><div align="right"><span class="Estilo76"><?echo round($subtotal,2);?></span></div></td>
		    <td scope="col"><div align="right"><span class="Estilo76"><?echo round($desc_factura1,2);?></span></div></td>
		    <td scope="col">&nbsp;</td>
		    <td scope="col">&nbsp;</td>
		    <td colspan="4" scope="col"><div align="right"><span class="Estilo76"><?echo round($total_factura,2);?></span></div></td>
  </tr>
</table>
