...
$porc_descuento_2= round(($precio_actualizado * $descuento_2)/100);
...
$desc_articulo = round(($precio_actualizado * $porc_dto)/100,2);
...
$sql9 = "SELECT count(*) as total FROM `ventas1_encab_temp_pc2`  WHERE  `nro_factura` = $nro_factura and tipo_fact = '$fact'";
...
$sql = "INSERT INTO `ventas1_deta_temp_pc2` ( `nro_factura` , `cod_detalle` , `cod_mercaderia` , `descripcion` , `presentacion` , `lote` , `mes_lote` , `anio_lote` , `cantidad` , `precio_unitario` , `total` , `tipo_fact`)  VALUES ('$nro_factura' , '' ,'$cod_mercaderia' , '$descripcion', '$presentacion' , '$lote' , '$mes_lote' , '$anio_lote' , '$dif' , '$precio' , '$total' , '$fact')";
mysql_query($sql);}
 
else
	{ 
$sql = "INSERT INTO `ventas1_deta_temp_pc2` ( `nro_factura` , `cod_detalle` , `cod_mercaderia` , `descripcion` , `presentacion` , `lote` , `mes_lote` , `anio_lote` , `cantidad` , `precio_unitario` , `total` , `tipo_fact`)  VALUES ('$nro_factura' , '' ,'$cod_mercaderia' , '$descripcion', '$presentacion' , '$lote' , '$mes_lote' , '$anio_lote' , '$cantidad' , '$precio' , '$total' , '$fact')";
mysql_query($sql);
	}
