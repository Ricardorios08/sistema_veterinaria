...
-->
 ...
 <table width="104%" height="363" border="0">
   ...
   <tr valign="middle" bgcolor="#FFFFFF">
     <td height="32" colspan="12"><div align="center" class="Estilo62"><strong>ASOdfdfdfCIACION BIOQUIMICA DE MENDOZA </strong></div></td>
   </tr>
   <tr valign="middle" bgcolor="#FFFFFF">
   ...
   <tr bgcolor="#FFFFFF">
     ...
     <td width="9%"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Total</span></div></td>
	      <td width="9%"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Comprobar</span></div></td>
   </tr>
   <tr>
...
$neto_gravado =strtoupper($result->fields["neto_gravado"]);
 ...
 $comprobar = $neto_gravado + $iva;

$descuen = $descuen + $descuento;
...
if ($cod_operacion == 3){
echo " -- nota ".$nota = $nota + $total;

}else{

echo "--ff- ".$total_final = $total_final + $total;
echo "<br>";
}

if ($total_final > 202268.98){
	echo "----". $nro_factura;
	echo "<br>";
}
...
BREAK;
 ...
 $nro_factura." - ".$total." - ".$comprobar;

if (round($total,2) != round($comprobar,2)){
	$error = "X";
$comprobar = $comprobar;
$suma_error = $total - $comprobar;
$comprobar = round($comprobar,2);

$ng = round(($neto/ 1.21),2);
$iva_ng  = round(($ng * 21)/100,2);

//echo  $sql1 = "UPDATE `ventas_encabezado` SET `neto_gravado` = '$ng' , `iva` = '$iva_ng' WHERE `tipo_fact` = '$tipo_fact' AND `nro_factura` = '$nro_fac'";
...
?>
     ...
     <td><div align="center" class="Estilo23">
    ...
    <td><div align="right" class="Estilo22"><?echo $comprobar;?></div></td>
     <?}else{?>
     <td><div align="right" class="Estilo22">
...
echo $nota;
echo "-";
echo $total_fin = $total_final - $nota;

//sin nota de credito
echo "---ghfg----".$suma_totales= $total_final_ri + $total_final_mon + $total_final_ex + $total_iva_mon + $total_iva_ri;


$diferencia = round($suma_totales - $total_fin,2);
...
$total_fa = $acumula_fact_ri+ $acumula_fact_mon + $acumula_fact_ex + $acumula_iva_ri + $acumula_iva_mon;
   ...
   <tr>
     ...
     <td class="Estilo62"><div align="right" class="Estilo66"><strong><?echo $total_fin;?></strong></div></td>
	    <td class="Estilo62"><div align="right" class="Estilo66"><strong><?echo $comprobar;?></strong></div></td>
   </tr>
 </table>
