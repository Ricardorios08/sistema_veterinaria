 ...
 <table width="103%" border="0">
   ...
   <tr valign="middle" bgcolor="#FFFFFF">
     <td colspan="5" valign="top"><div align="center" class="Estilo67 Estilo72"><strong>FRANCISCO M. LOPEZ</strong></div>       
       <div align="center" class="Estilo69 Estilo73"><strong>_________ VENTAS _______ </strong></div>       <div align="center" class="Estilo71 Estilo23">RIOJA 0000 - 5500 MENDOZA </div>       <div align="center" class="Estilo71 Estilo23">IVA RESPONSABLE INSCRIPTO </div></td>
   ...
   <hr noshade>     </tr>
   <tr bgcolor="#FFFFFF">
     <td width="30"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Fecha</span> </div>
     <td width="120"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Comprobante</span></div>
     <td width="118">
       <div align="center"><span class="Estilo6 Estilo2  Estilo5">Denominaci&oacute;n</span></div>
     <td width="19"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Tipo</span></div></td>
     <td width="49"><div align="center"><span class="Estilo6 Estilo2  Estilo5">CUIT</span></div></td>
     <td width="41"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Resp. Inscrip </span></div></td>
     <td width="48"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Monotributo</span></div></td>
     <td width="41"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Exento</span></div></td>
     <td width="28"><div align="center"><span class="Estilo6 Estilo2  Estilo5">IVA R.I </span></div></td>
     <td width="48"><div align="center"><span class="Estilo6 Estilo2  Estilo5">IVA Mon. </span></div></td>
     <td width="60"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Total</span></div></td>
   </tr>
   <tr>
...
if ($nro_cliente != 0){
$sql1="select cuit from clientes where cuenta = $nro_cliente";
$result1 = $db_pro->Execute($sql1);
$cuit=strtoupper($result1->fields["cuit"]);

}
elseif ($nro_cuenta != 0){
$sql1="select nro_afip from afip where nro_laboratorio= $nro_cuenta";
$result1 = $db_bq->Execute($sql1);
$cuit=strtoupper($result1->fields["nro_afip"]);
}
...
?>
     ...
     <td><div align="center" class="Estilo5"><span class="Estilo5"><?print("$condicion");?></span>
     ...
     <td><div align="right" class="Estilo5">
       <div align="right" class="Estilo5">(-<?echo $mon_nc;?>)</div>
     </div></td>
     <td><div align="right" class="Estilo5">
       <div align="right" class="Estilo5">(-<?echo $ex_nc;?>)</div>
     </div></td>
     <td><div align="right" class="Estilo5">
       <div align="right">(-<?echo $iva_nc;?>)</div>
     </div></td>
     <td><div align="right" class="Estilo5">
       <div align="right" class="Estilo5">(-<?echo $iva_mon_nc;?>)</div>
     </div></td>
     <td><div align="right" class="Estilo5">
       <div align="right">(-<?echo $total;?>)</div>
     </div></td>
     <?}else{?>
     <td width="18"><div align="right" class="Estilo5">
       <div align="right"><?echo $neto_gravado_ri;?></div>
     </div></td>
     <td width="18"><div align="right" class="Estilo5"><?echo $neto_gravado_mon;?></div></td>
     <td width="18"><div align="right" class="Estilo5">
     ...
     <td width="18"><div align="right" class="Estilo5"><?echo $iva_mon;?></div></td>
     <td width="18"><div align="right" class="Estilo5"><?echo $total;?></div></td>
     <?}?>
   </tr>
   <?$neto_gravado_ri= "";
$neto_gravado_mon= "";
