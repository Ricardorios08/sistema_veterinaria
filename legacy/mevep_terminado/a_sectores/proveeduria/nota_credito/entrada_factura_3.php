...
$tipo_fact=strtoupper($result7->fields["iva"]);
...
$tipo_fact=strtoupper($result2->fields["sit_iva"]);
...
include("../../../conexiones/config_pro.php");
 ...
 $sql = "INSERT INTO `notacredito_encab_temp` ( `tipo_fact` , `nro_factura` , `cod_operacion` , `tipo` , `nro_cliente` , `nro_cuenta` , `plan` , `operador` , `denominacion` , `fecha` , `forma_pago` , `porc_dto`) VALUES ( '$tipo_fact_afectado'  , '$nro_factura_nc' , '$cod_operacion' , '$tipo_iva' , '$nro_cliente' , '$nro_cuenta' , '$plan' , '$operador' , '$denominacion' , '$fecha' , '$forma_pago' , '$porc_dto' )";
mysql_query($sql);
...
<table width="99%" border="0">
          <!--DWLayoutTable-->
          <tr bgcolor="#000099">
            <td height="31" bordercolor="#000000" class="Estilo67"><div align="center"><span class="Estilo26"><span class="Estilo70"><span class="Estilo4 Estilo6  Estilo16 Estilo70"><span class="Estilo4 Estilo16  Estilo6"><span class="Estilo71"><span class="Estilo72">&nbsp;              &nbsp;&nbsp;&nbsp;&nbsp;</span></span></span></span></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="Estilo72"> NOTA DE CREDITO N&ordm;:</span> <span class="Estilo72"><?echo $tipo_fact;?> - <?echo $nro_factura_nc;?> &nbsp;&nbsp;&nbsp;</span><span class="Estilo26">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="Estilo26"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="Estilo72">&nbsp;&nbsp;</span></span></span><span class="Estilo72"><span class="Estilo26">&nbsp;&nbsp;&nbsp;</span><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22"><span class="Estilo26">  </span></span></span></span></span></div></td>
            <td height="31" colspan="2" bordercolor="#000000" class="Estilo67"><div align="center"></div>              <div align="center"><span class="Estilo72">FECHA: <?echo $dia;?> / <?echo $mes;?> / <?echo $anio?> - Operador: <?echo $operador;?> <span class="Estilo26">&nbsp;</span></span></div></td>
          </tr>
          <tr bgcolor="#E6E6E6">
            <td width="368" height="28" valign="middle" bordercolor="#000000" class="Estilo67"><div align="right" class="Estilo18 Estilo79">
              <div align="center"><span class="Estilo14 Estilo41 Estilo27"><strong>CLIENTE: <?print("$denominacion");?> - </strong>FORMA DE PAGO: <?echo $forma_pago;?></span> </div>
            </div></td>
            <td width="337" valign="middle" bordercolor="#000000" class="Estilo80"><div align="center">Factura Afectada Nº: <?echo $nro_factura;?> - Fecha Emisi&oacute;n: <?echo $fecha;?></div></td>
            <td bordercolor="#000000" class="Estilo67"><div align="center" class="Estilo79">Total: $ <?echo number_format($total_fact,2);?></div></td>
          </tr>


		  
          <tr bgcolor="#C4D7E6">
            <td height="57" colspan="3" bgcolor="#E8DCFC"><div align="left"><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22"><span class="Estilo26"> PRODUCTO: 
              ...
              <input name="cod_mercaderia" type="text" class="Estilo22" id="cod_mercaderia" onKeyPress="return verif_caracter(this,event)" value="<?php if (isset($_REQUEST['cod_merca']))   echo $_REQUEST['cod_merca'];?>" size = "5">
                      ...
                      </span></span></span></span> <strong><span class="Estilo44"><span class="Estilo43"><? $cod_merquita; ?></span></span></strong><span class="Estilo26">
                     ...
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><a href="control_nro_factura.php?&&nro_factura=<?print("$nro_factura");?>&&fact=<?print("$fact");?>&&tipo_fact=<?print("$tipo_fact");?>&&direccion=<?print("$direccion");?>&&cuit=<?print("$cuit");?>"><img src="../../../imagenes/office/1049.ico" alt="Confirmar" border = "0"> CONFIRMAR NOTA DE CREDITO</a><span class="Estilo26"></span></div></td>
    </tr>
...
echo $tipo_fact_afectado = $_REQUEST['tipo_fact_afectado'];
echo $nro_factura_nc= $_REQUEST['nro_factura_nc'];
