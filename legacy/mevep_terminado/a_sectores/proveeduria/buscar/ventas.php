...
<!-- <A HREF="imp_pendientes.php?a='imprimir'&&buscar_por=<?php print("$buscar_por");?>&&nro_factura=<?php print("$nro_factura");?>&&mes=<?php print("$mes");?>&&anio=<?php print("$anio");?>"><IMG SRC="../../../imagenes/botones//btn_imprimir.gif" alt="Imprimir" border = "0"></A>  -->
...
<table width="854" height="127" border="0">
  <!--DWLayoutTable-->
  <tr valign="middle" bgcolor="#000099">
    <td height="32" colspan="12"><div align="center" class="Estilo97"><span class="Estilo96"><span class="Estilo3">Listado de Facturas Vendidas. Emitidas al: </span><?php ECHO $hoy;?></span> </div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
    <td width="11%"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Fecha</span> </div>
    <td width="11%"><div align="center"><span class="Estilo6 Estilo2  Estilo5">N&ordf; Factura</span> </div>
    ...
    <td width="7%"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Descuento</span></div></td>
    <td width="8%"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Neto Gr </span></div></td>
    <td width="7%"><div align="center"><span class="Estilo6 Estilo2  Estilo5">IVA</span></div></td>
...
if (($mes == 13) && ($nro_factura == "") && ($cliente_proveedor == "")){
 ...
 $sql="select * from ventas_encabezado where  ((nro_cuenta = $cliente_proveedor) or (nro_cliente = $cliente_proveedor))  ORDER by nro_cuenta, nro_cliente, nro_factura, fecha desc";
    ...
    $sql="select * from ventas_encabezado where fecha BETWEEN  '$desde' AND  '$hasta' ORDER by fecha  , nro_cuenta, nro_cliente, nro_factura";
}elseif (($mes != 13) && ($nro_factura != "") && ($cliente_proveedor == "")){
...
?>
  <tr bgcolor="#FFFFFF">
    <td><div align="center"><span class="Estilo5"><span class="Estilo2"><?php print("$fecha");?></span></span></div></td>
    <td>      <div align="center" class="Estilo5">
        <div align="left"><span class="Estilo2"><?php print("$movimiento");?> <?php print("$tipo_fact");?> - </span><span class="Estilo5"><span class="Estilo2"><a href="cambiar_numero.php?nro_factura=<?php print("$nro_factura");?>&&tipo_fact=<?php print("$tipo_fact");?>&&forma_pago=<?php print("$forma_pago");?>" target = "central" title = "Presione Aqui si quiere cambiar el numero de Factura" ><font color="#0000FF"><?php print("$nro_factura");?></font></a></span></span></div>
    </div></td>
    <td width="1%"><!--DWLayoutEmptyCell-->&nbsp;</td>
    <td width="29%" height="22"><div align="right"></div>      
      <span class="Estilo92"> <?php print("$cuenta");?> - 
    <?php print("$denominacion");?></span></td>
    <td><div align="center"><span class="Estilo5"><span class="Estilo91"><?php print("$forma_pago");?></span></span></div></td>
    <!-- <td><div align="center" class="Estilo6"><span class="Estilo4 Estilo5"><?php print("$proveedor");?></span></div></td> -->
    <td><div align="center" class="Estilo5">
      <div align="right"><span class="Estilo89"><?php echo $bruto;?> </span></div>
    </div></td>
    <td><div align="center" class="Estilo5">
      <div align="right"><span class="Estilo89"><?php echo $descuento;?> </span></div>
    </div></td>
    <td><div align="right"><span class="Estilo5"><span class="Estilo89"><?php echo $neto_gravado;?></span></span></div></td>
    <td><div align="right"><span class="Estilo5"><span class="Estilo89"><?php echo $iva;?></span></span></div></td>
    <td><div align="center" class="Estilo5">
      <div align="right"><span class="Estilo83"><?php echo $total;?> </span></div>
    </div></td>
     <td><div align="center"><font color="#000000" size="2"><a href="detalle_ventas.php?nro_factura=<?php print("$nro_factura");?>&&tipo_fact=<?php print("$tipo_fact");?>"><img src="../../../imagenes/office//009.ico" alt="Imprimir Detalle" width="17" height="16" border = "0" target= "_top"></a></font></div></td>
  </tr>
...
$cantidad = $cantidad + 1;
    ...
    <td><div align="right" class="Estilo96"><span class="Estilo93"><?php echo number_format($total_subtotal,2);?></span></div></td>
    <td><div align="right" class="Estilo96"><span class="Estilo97"><span class="Estilo89"><span class="Estilo93 Estilo96"><?php echo number_format($total_descuento,2);?></span></span></span></div></td>
    <td><div align="right" class="Estilo96"><span class="Estilo93"><?php echo number_format($total_neto_gravado,2);?></span></div></td>
    <td><div align="right" class="Estilo96"><span class="Estilo93"><?php echo number_format($total_iva,2);?></span></div></td>
    <td><div align="right" class="Estilo96"><span class="Estilo93"><?php echo number_format($total_facturas,2);?></span></div></td>
    <td><!--DWLayoutEmptyCell-->&nbsp;</td>
  </tr>
</table>
