...
$incremento1 = round(($precio_actualizado * 21)/100,2);
$precio_actualizado = $precio_actualizado + $incremento1;
$incremento2 = round(($precio_actualizado * 21)/100,2);
$precio_actualizado = $precio_actualizado + $incremento2;
