...
switch ($buscador_rapido)
{
	...
	<a href="clientes/modificar.php?id=<?print("$cuenta");?>"><IMG SRC="../../imagenes/office/027.ico" alt="Modificar" border = "0"></a></font></div></td>
	    <td bordercolor="#E8DCFC" bgcolor="#9FE1BB"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="clientes/borra.php?id=<?print("$cuenta");?>"><IMG SRC="../../imagenes/office/027.ico" alt="Modificar" border = "0"></a></font></div></td>
