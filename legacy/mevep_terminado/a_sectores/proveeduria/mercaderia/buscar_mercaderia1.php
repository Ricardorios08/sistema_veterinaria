...
<table width="860" height="62" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#666666">
    <td colspan="17"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">LISTADO DE MERCADERIA . Emitido el <?php echo $hoy;?> </font></div></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#A0A7F5">
    ...
    <td width="22%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">PRODUCTO</font> / <font color="#000000" size="2" face="Arial, Helvetica, sans-serif">DESCRIPCION</font></div></td>
    <td width="10%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">PROVEEDOR</font></div></td>
    <td width="11%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">MARCA</font></div></td>
    <td width="9%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">CATEGORIA</font></div></td>
    <td width="10%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">EXIS.</font></div></td>
 
    <td width="6%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">SOCIO</font></div></td>
<td width="10%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">PARTICULAR</font></div></td>
  <td width="5%"><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">IMP</font></div></td>
...
$categoria=$result2->fields["categoria"];
 ...
 $precio_socio = $precio_particular - $precio_socio;
...
?>
    ...
    <td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php ECHO $marca;?></font></div></td>
    <td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php ECHO $categoria;?></font></div></td>
    <td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo $suma_existente;?></font></div></td>

    <td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo number_format($precio_socio,2);?></font></div></td>

    <td bordercolor="#E8DCFC" bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo number_format($precio_particular,2);?></font></div></td>

    <td bordercolor="#E8DCFC" bgcolor="#9FE1BB"><div align="center"><a href="codigo128/prueba.php?cod_merca=<?php print("$cod_merca");?>"><IMG SRC="../../imagenes/office/005.ico" alt="Modificar" border = "0"></a></div></td>
...
?>
    <tr>
      <td height="20" colspan="11" bgcolor="#666666"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">CANTIDAD DE MERCADERIA <?php ECHO $cont;?></font></div></td>
    </tr>
</table>
