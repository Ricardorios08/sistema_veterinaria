...
$sql = "INSERT INTO `ventas1_encab_temp` ( `tipo_fact` , `nro_factura` , `cod_operacion` , `tipo` , `nro_cliente` , `nro_cuenta` , `plan` , `operador` , `denominacion` , `fecha` , `forma_pago` , `porc_dto`) VALUES ( '$fact'  , '$nro_factura' , '$cod_operacion' , '$tipo_iva' , '$nro_cliente' , '$tipo_precio' , '$plan' , '$operador' , '$todo1' , '$fecha' , '$forma_pago' , '$porc_dto' )";
mysql_query($sql);
...
<table width="750" border="0">
          <!--DWLayoutTable-->
          <tr bgcolor="#000099">
            <td height="31" colspan="5" bordercolor="#000000" class="Estilo67"><div align="left"><span class="Estilo26"><span class="Estilo70"><span class="Estilo4 Estilo6  Estilo16 Estilo70"><span class="Estilo4 Estilo16  Estilo6"><span class="Estilo71"><span class="Estilo72">LAB: <?php echo $todo;?>&nbsp;&nbsp;&nbsp;              &nbsp;&nbsp;&nbsp;&nbsp;</span></span></span></span></span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="Estilo72"> N&ordm; FACTURA:</span> <span class="Estilo72"><?php echo $fact;?> - <?php echo $nro_factura;?> &nbsp;&nbsp;&nbsp;</span><span class="Estilo26">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="Estilo72">FECHA: <?php echo $dia;?> / <?php echo $mes;?> / <?php echo $anio?></span><span class="Estilo26"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="Estilo72">&nbsp;&nbsp;</span></span></span>Op:</span> <span class="Estilo72"><?php echo $operador;?></strong> <span class="Estilo26">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22"><span class="Estilo26"> <span class="Estilo70">&nbsp;Lista: <?php echo $tipo_precio;?></span> &nbsp;&nbsp; </span></span></span></span></span></div>              </td>
          </tr>
          <tr bgcolor="#000099">
            <td height="31" colspan="5" bordercolor="#000000" class="Estilo67"><span class="Estilo26"><span class="Estilo70"><span class="Estilo4 Estilo6  Estilo16 Estilo70"><span class="Estilo4 Estilo16  Estilo6"><span class="Estilo71"><span class="Estilo72">TIPO IVA: <?php echo strtoupper($tipo_fact);?> &nbsp;&nbsp;&nbsp;&nbsp; FORMA DE PAGO: <?php echo strtoupper($forma_pago);?>
                     

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PLAN: <?php echo strtoupper($plan);?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Descuento: <?php echo $porc_dto;?> % <span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22">
<!-- <input name="porc_dto2" type="text" class="Estilo22" id="porc_dto2" value="<?php echo $porc_dto;?>" size = "5"> -->
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><a href="control_nro_factura.php?&&nro_factura=<?print("$nro_factura");?>&&fact=<?print("$fact");?>&&tipo_fact=<?print("$tipo_fact");?>&&direccion=<?print("$direccion");?>&&cuit=<?print("$cuit");?>"><img src="../../../imagenes/office/1049.ico" alt="Confirmar" border = "0"> CONFIRMAR</a><span class="Estilo26"></span></div></td>
    </tr>
