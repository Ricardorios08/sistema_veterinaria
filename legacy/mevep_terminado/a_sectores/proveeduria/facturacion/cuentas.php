...
if ($band == "SI"){	
$iva_total = round($iva_total * $dif,2);
$iva_renglon = $iva_renglon * $dif;
$iva_total = round(($iva_total) * 1,2);
		}
	else{
				
$iva_total = round($iva_total * $cantidad,2);
$iva_renglon = $iva_renglon * $cantidad;
$iva_total = round(($iva_total) * 1,2);
}
...
if ($band == "SI"){	
$iva_total = $precio_unitario * $dif;}
else{
$iva_total = $precio_unitario * $cantidad;		}
}
