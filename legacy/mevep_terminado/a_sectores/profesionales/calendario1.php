...
?>
  <td bgcolor="#8FA5FA"><div align="center">
    <div align="center" class="Estilo8"><a href="agregar_turno.php?dia=<?php print("$c");?>&&cod_socio=<?php print("$cod_socio");?>&&mes1=<?php print("$mes1");?>&&anio1=<?php print("$anio1");?>&&profesionales=<?php print("$profesionales");?>"><?php echo $c;?> AGREGAR </a>
            <?php include ("hoy.php");?>
    </div>
    <br>
  </div></td>
...
?>
    <td bordercolor="#EEEEEE" bgcolor='#C9CFC7'><div align="rigth" class="Estilo7">
      <div align="center"><span class="Estilo5"><a href="agregar_turno.php?dia=<?php print("$c");?>&&cod_socio=<?php print("$cod_socio");?>&&mes1=<?php print("$mes1");?>&&anio1=<?php print("$anio1");?>&&profesionales=<?php print("$profesionales");?>"><?php echo $c;?> AGREGAR </a>
        <?php include ("hoy.php");?>
        </span></div>
    </div></td>
    <?php
}else{?>
      <td bgcolor="#C9CFC7"><div align="center" class="Estilo7 Estilo9"><a href="agregar_turno.php?dia=<?php print("$c");?>&&cod_socio=<?php print("$cod_socio");?>&&mes1=<?php print("$mes1");?>&&anio1=<?php print("$anio1");?>&&profesionales=<?php print("$profesionales");?>"><?php echo $c;?> AGREGAR </a>
              <?php include ("hoy.php");?>
    </div></td>
    <?php
}
