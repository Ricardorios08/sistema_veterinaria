...
<!DOCTYPE html> <html lang="es"> <head> <!--http://www.lawebdelprogramador.com-->
...
<body> <h1>PROFESIONAL</h1>
<table width="850" id="calendar">
...
for($i=1;$i<=42;$i++) { 
	...
	echo "<td> </td>"; }
		...
		// mostramos el dia 
		if($day==$diaActual) echo "<td class='hoy'>$day </td>";
		else
		echo "<td>$day </td>"; $day++; 
		} 
