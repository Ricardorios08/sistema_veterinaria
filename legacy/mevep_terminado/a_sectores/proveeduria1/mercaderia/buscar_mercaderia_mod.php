...
<table width="650" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#666666">
    <td colspan="14"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">LISTADO DE MERCADERIA . Emitido el <?echo $hoy;?> </font></div></td>
  </tr>
...
?>    <tr><td bgcolor="#9FE1BB"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><?print("$cod_merca");?></font></div></td>
<td bgcolor="#9FE1BB"><div align="left"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$nombre");?></font></div></td>
<td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?print("$tipo_moneda");?></font></div></td>
<td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?ECHO $costo1;?></font></div></td>
<td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?ECHO $en_dolar;?></font></div></td>
 <td bordercolor="#E8DCFC" bgcolor="#9FE1BB"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="mercaderia/modificar_mercaderia.php?cod_merca=<?print("$cod_merca");?>"><img src="../../imagenes/office/027.ico" alt="Modificar" border = "0"></a></font></div></td>
    <td bordercolor="#E8DCFC" bgcolor="#9FE1BB"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="mercaderia/borra.php?cod_merca=<?print("$cod_merca");?>"><img src="../../imagenes/office/1047.ico" alt="Eliminar" border = "0"></a></font></div></td>
    <td bordercolor="#E8DCFC" bgcolor="#9FE1BB"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="mercaderia/ficha.php?cod_merca=<?print("$cod_merca");?>"><img src="../../imagenes/office/005.ico" alt="Ficha" border = "0"></a></font></div></td>
  </tr>
  <?
