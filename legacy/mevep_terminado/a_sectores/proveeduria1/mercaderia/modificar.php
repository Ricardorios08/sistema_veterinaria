...
$sql = "UPDATE `mercaderia` SET `descripcion` = '$descripcion' , `nombre` = '$nombre' , `tipo` = '$`tipo`' , `factorconver` = '$factorconver' ,  `cadenafrio` = '$cadenafrio' ,  `proveedor` = '$proveedor' ,   `fabricante` = '$fabricante'   , `presentacion` = '$presentacion' ,   `margendif` = '$margendif'  , `id_proveedor` = '$proveedor' ,   `id_tasa` = '$cod_tasa'  WHERE `cod_merca` = '$cod_merca'";
 mysql_query($sql);
