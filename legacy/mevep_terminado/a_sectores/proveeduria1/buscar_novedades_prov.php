...
$sql = "SELECT * FROM `novedades` where  transaccion like 'TR%' and cod_ajuste = 6 order by nro_laboratorio desc";
...
$sql3 = "SELECT sum(importe) as total FROM `novedades` where  nro_laboratorio = $nro_laboratorio and cod_ajuste = 6 ";
$result3 = $db_cont->Execute($sql3);
