...
<table width="114%" height="125" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#F2F2F2">
    <td height="32" colspan="9"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">Desde: <? echo $fecha_desde1;?> Hasta: <?echo $fecha_hasta1;?>  </font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font color="#000000" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp; <strong><font color="#0000FF" size="2">DEUDORES POR VENTA PROVEEDURIA AL: <?echo $fecha_hasta1;?></font></strong> <font size="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>&nbsp;&nbsp;&nbsp;Impreso el:<?echo $hoy;?> </font></div></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#000099">

	<td width="16%" height="19"><div align="center"><font color="#99FFFF"><strong><font size="2" face="Arial, Helvetica, sans-serif">CUENTA</font></strong></font></div></td>
    <td width="40%"><div align="center"><font color="#99FFFF"><strong><font size="2" face="Arial, Helvetica, sans-serif">DENOMINACION</font></strong></font></div></td>
    <td width="24%"><div align="center"><font color="#99FFFF"><strong><font size="2" face="Arial, Helvetica, sans-serif">TIPO CUENTA </font></strong></font></div></td>
    <td width="20%"><div align="center"><font color="#99FFFF"><strong><font size="2" face="Arial, Helvetica, sans-serif">SALDO</font></strong></font></div></td>
</tr>
...
$palabra= $result_pr->fields["cuenta"];
 ...
 $sql="select sum(importe) as composicion from resumen_cta_vta where cuenta like '$palabra' and tipo_cuenta = $tipo and fecha between '$fecha_desde' and '$fecha_hasta' and ((cod_movimiento = '1') or (cod_movimiento = '01') or (cod_movimiento = '2') or (cod_movimiento = '02')) ";
$result = $db_pro->Execute($sql);
 $suma=strtoupper($result->fields["composicion"]);

 $sql="select sum(importe) as composicion from resumen_cta_vta where cuenta like '$palabra' and tipo_cuenta = $tipo and fecha between '$fecha_desde' and '$fecha_hasta' and ((cod_movimiento = '3') or (cod_movimiento = '03'))";
$result = $db_pro->Execute($sql);
