...
?>
  ...
  <tr bgcolor="#FFFFFF">
    <td scope="col"><span class="Estilo43"><span class="Estilo37 Estilo39 Estilo40"><a href="ver_compra.php?cod_merca=<?print("$cod_merca");?>&&fecha=<?print("$fecha1");?>"><span class="Estilo39"><?print("$cod_merca");?>
</span></span></td>
    <td scope="col"><div align="left" class="Estilo44"><span class="Estilo37"><?echo $descripcion;?></span></div></td>
	<td scope="col"><div align="left" class="Estilo44">
	  <div align="center"><span class="Estilo37"><?echo $presentacion;?></span></div>
	</div></td>
	<td scope="col"><div align="left" class="Estilo44">
	  <div align="center"><span class="Estilo37 Estilo45"><strong>$ <?echo $precio_actualizado;?></strong></span></div>
	</div></td>
  </tr>
