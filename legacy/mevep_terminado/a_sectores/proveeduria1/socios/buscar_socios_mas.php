...
*/
    ...
    $sql4="select * from animal where nombre like '%$palabra%' or especie like '%$palabra%' or raza like '%$palabra%'  ";
...
<table width="800" border="0" cellspacing="0">
  ...
  <tr bordercolor="#FFFFCC" bgcolor="#CCCCCC">
    ...
    <td width="356"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS"> APELLIDO Y NOMBRE </font></strong></div></td>
    <td width="69"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS">TELEFONO</font></strong></div></td>
    <td width="137"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS">LOCALIDAD</font></strong></div></td>
    <td width="49"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS">BORRAR</font></strong></div></td>
    <?php 
  ...
  while (!$result4->EOF) {
	...
	$nombre=strtoupper($result4->fields["nombre"]);
$especie=strtoupper($result4->fields["especie"]);
$raza=strtoupper($result4->fields["raza"]);
$pelaje=strtoupper($result4->fields["pelaje"]);
$tamanio=strtoupper($result4->fields["tamanio"]);
$color=strtoupper($result4->fields["color"]);
$sexo=strtoupper($result4->fields["sexo"]);
$fecha_nac=strtoupper($result4->fields["fecha_nac"]);
$cod_animal=strtoupper($result4->fields["cod_animal"]);
$cod_socio=strtoupper($result4->fields["cod_socio"]);
...
$telefono = "-";
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
    ...
    <td bordercolor="#E8DCFC" bgcolor="#FFFF99"><div align="center"><strong><font face="Trebuchet MS"><a href="modificar_socio.php?cod_socio=<?php print("$cod_socio");?>" class="Estilo4"><?php print("$apellido");?>, <?php print("$nombre");?></a></font></strong></div></td>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bordercolor="#E8DCFC"><font size="2" face="Trebuchet MS">Deuda: <?php 
...
?>
        ...
        <tr bgcolor="#EBEBEB">
          ...
          <td><div align="center" class="Estilo3"><font face="Trebuchet MS"><a href="modificar_mascota.php?cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong><?php print("$nombre");?></strong></a></font></div>          <div align="center"></div></td>
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS">TAMA&Ntilde;O</font></div></td>
          <td colspan="2" ><div align="center"><font size="2" face="Trebuchet MS"><?php print("$tamanio");?></font></div></td>
        </tr>
        <tr bgcolor="#EBEBEB">
          ...
          <td colspan="2" valign="top"><div align="center"><font size="2" face="Trebuchet MS"><?php print("$color");?></font></div></td>
        </tr>
        <tr bgcolor="#EBEBEB">
          ...
          <td colspan="2" valign="top"><div align="center"><font size="2" face="Trebuchet MS"><?php print("$sexo");?></font></div></td>
        </tr>
        <tr bgcolor="#EBEBEB">
          ...
          <td colspan="2" valign="top"><div align="center"><font size="2" face="Trebuchet MS"><?php print("$fecha_nac");?></font></div></td>
        </tr>
        <?php 
