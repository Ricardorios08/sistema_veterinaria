...
<form action="pagar_multiple.php" method="post" target = "central">
...
?>
<tr>
  <td colspan="10" bgcolor="#CCCCCC"><div align="center">$<?php echo $total_importe;?> <input type="submit" name="Submit" value="PAGAR">
