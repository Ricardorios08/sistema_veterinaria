...
<BODY onload = "on_load ()">
<form action ="cambiar.php" method="post" target ="central">
  <table width="698" border="0">
    <tr bgcolor="#000099">
      <td height="34" colspan="3"><div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>Cambiar N&uacute;mero de Factura y Anular Factura Anterior </strong></font></div></td>
    </tr>
    <tr bgcolor="#E1F2EF">
...
<input type = "submit" name = "ok" value = "Cambiar">
</font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;

</font><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif">&nbsp;      </font></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#E6E6E6"><div align="justify"><font size="2"><em><font color="#006600" face="Arial, Helvetica, sans-serif">ESTA OPERACION CAMBIARA EL NUMERO DE FACTURA CUANDO EL ESTADO SEA PENDIENTE DE PAGO POR PARTE DE UNA OBRA SOCIAL E INCIDIRA LOS CAMBIOS EN ORDENES FACTURAS, FACTURAS Y COMPOSICION DE SALDO DE UNA FACTURA. </font></em></font></div></td>
    </tr>
  </table>
</form>
</body>