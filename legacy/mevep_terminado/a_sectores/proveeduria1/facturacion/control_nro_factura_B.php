...
.Estilo62 {font-family: Arial, Helvetica, sans-serif; font-weight: bold; }
body {
...
<table width="650" border="0">
  <!--DWLayoutTable-->
  <tr>
    <td height="28" colspan="4" ><div align="center" class="Estilo15" >
          <div align="center" class="Estilo14"><span class="Estilo17"><span class="Estilo18"><span class="Estilo14 Estilo17">
          </span></span></span></div>
    </div>      <div align="center"><span class="Estilo14"> <span class="Estilo62">REVISAR FACTURA E IMPRIMIR</span></span></div> <div align="center">
    </div></td>
    </tr>
  <tr bgcolor="#E6E6E6">
    <td colspan="4" valign="top" ><div align="center"><span class="Estilo14"><span class="Estilo17"><span class="Estilo18"><span class="Estilo14 Estilo17">
        <input name="button" type="button" id ="button4" style="font-family: Verdana; font-size: 14 pt" onClick="history.back()" onKeyPress="history.back()" value="CORREGIR">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input name="impri" type="image" src="../../../imagenes/botones/btn_imprimir.gif" id ="impri" value="IMPRI" onClick="return confirm('Si est&aacute;n todos los datos correctos IMPRIMA');">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
<input name="actua" type="submit" id ="actua" value="ACTUALIZAR" onClick="return confirm('Si est&aacute;n todos los datos correctos ACTUALIZA STOCK');">
</span></span></span></span></div></td>
    </tr>
  <tr bgcolor="#C1F2FF">
    <td colspan="2" bgcolor="#C9FADF"><div align="right" class="Estilo4 Estilo16"><span class="Estilo17  Estilo14">N&ordm; FACTURA EMITIDO POR SISTEMA: </span></div></td>
    <td width="390" colspan="2" bgcolor="#F2FACB"><span class="Estilo14 Estilo4"><?echo $fact;?> - <?echo $nro_factura;?> </span></td>
  </tr>
  <tr bgcolor="#C1F2FF">
    <td colspan="2" bgcolor="#C9FADF"><div align="right" class="Estilo17"><span class="Estilo18">En caso de no coincidir Cambiar por:
      </span></div></td>
  ...
  <tr bgcolor="#C1F2FF">
    <td colspan="2" bgcolor="#C9FADF"><div align="right" class="Estilo17"><span class="Estilo18">
...
<input name="leyenda1" type="text" id="leyenda12" size="30" maxlength="30"  onKeyPress="return verif_caracter(this,event)">      
  ...
  <tr bgcolor="#C1F2FF">
    <td colspan="2" bgcolor="#C9FADF"><div align="right" class="Estilo17">Cantidad de Cuotas</div></td>
    <td colspan="2" bgcolor="#F2FACB"><span class="Estilo14 Estilo17">
 ...
 <table width="650" height="68" border="0">
      <!--DWLayoutTable-->
      <tr bgcolor="#C4D7E6">
...
<table width="650" border="0">
        ...
        <td colspan="2" valign="middle"><div align="center" class="Estilo11 Estilo4 Estilo7 Estilo10 Estilo21 Estilo16">
...
$iva_articulo = round(($precio_actualizado * $iva_normal)/100,3);
...
<tr bgcolor="#A0A7F5">
  <td height="20" colspan="2" scope="col"><div align="center"><span class="Estilo4 Estilo28"><strong>Subtotal</strong></span></div>    <div align="right"></div></td>
  <td height="20" colspan="2" scope="col"><div align="center"><span class="Estilo4 Estilo13"><span class="Estilo23"><span class="Estilo24"><span class="Estilo28"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4">Descuento</span></span></span></span></span></div></td>
  <td colspan="2" scope="col"><div align="right"><span class="Estilo4 Estilo13"><span class="Estilo23"><span class="Estilo24"><span class="Estilo28"></span></span></span></span></div>    
    <div align="center"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><strong>TOTAL</strong></span></div>    </span></td>
  </tr>
<tr bgcolor="#E6E6E6">
  <td height="20" colspan="2" scope="col"><div align="center"><span class="Estilo4 Estilo28"><strong>$ <?echo number_format($subtotal,2);?></strong></span></div></td>
  <td height="20" colspan="2" scope="col"><div align="center"><span class="Estilo4 Estilo13"><span class="Estilo23"><span class="Estilo24"><span class="Estilo28"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4">$ <?echo number_format($desc_factura1,2);?></span></span></span></span></span></div></td>
  <td colspan="2" scope="col"><div align="center"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><strong>$ <?echo number_format($total_factura,2);?> </strong></span></div></td>
</tr>
 </table>
