...
$tipo_preci=$_REQUEST["tipo_precio"];
	for ($i=0;$i<count($tipo_preci);$i++)    
	{     
	$tipo_precio = $tipo_preci[$i];    
	}
...
if ($nro_cliente ==0){
$leyenda = "Debe Ingresar un cliente";
include ("../../../alertas/campo_vacio.php");
exit;
}

if (($nro_cliente ==1) && ($forma_pago == 'CTA/CTE')){
$leyenda = "NO PUEDE VENDER COMO CONSUMIDOR FINAL EN CUENTA CORRIENTE";
include ("../../../alertas/campo_vacio.php");
exit;
}
...
EXIT;
 ...
 $sql="select * from ventas_encabezado where tipo_fact = '$fact' GROUP BY nro_factura ORDER BY nro_factura DESC";
$result = $db->Execute($sql);
...
$sql = "INSERT INTO `ventas1_encab_temp` ( `tipo_fact` , `nro_factura` , `cod_operacion` , `tipo` , `nro_cliente` , `nro_cuenta` , `plan` , `operador` , `denominacion` , `fecha` , `forma_pago` , `porc_dto`) VALUES ( '$fact'  , '$nro_factura' , '$cod_operacion' , '$tipo_iva' , '$nro_cliente' , '$matricula1' , '$plan' , '$operador' , '$todo1' , '$fecha' , '$forma_pago' , '$porc_dto' )";
mysql_query($sql);
...
<table width="650" border="0">
          <!--DWLayoutTable-->
          <tr bgcolor="#000099">
            <td height="41" colspan="5" bordercolor="#000000" class="Estilo67"><div align="center"><span class="Estilo26"><span class="Estilo70"><span class="Estilo4 Estilo6  Estilo16 Estilo70"><span class="Estilo4 Estilo16  Estilo6"><span class="Estilo71"><span class="Estilo72">CLIENTE: <?echo $todo;?>&nbsp;&nbsp;&nbsp;</span></span></span></span></span>&nbsp;&nbsp;</span><span class="Estilo72"> N&ordm; FACTURA:</span> <span class="Estilo72"><?echo $fact;?> - <?echo $nro_factura;?> &nbsp;&nbsp;&nbsp;</span><span class="Estilo26">&nbsp;</span><span class="Estilo72">FECHA: <?echo $dia;?> / <?echo $mes;?> / <?echo $anio?></span><span class="Estilo26"> &nbsp;&nbsp;&nbsp;&nbsp;</span><span class="Estilo72">&nbsp;&nbsp;</span></span></span>Operador: </span> <span class="Estilo72"><?echo $operador;?></strong> <span class="Estilo26">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22"><span class="Estilo26">  </span></span></span></span></span></div></td>
          </tr>
          <tr>
            <td colspan="5" bordercolor="#000000" class="Estilo67"><!--DWLayoutEmptyCell-->&nbsp;</td>
    </tr>
          <tr bgcolor="#A0A7F5">
            <td colspan="5" bordercolor="#000000" class="Estilo67"><div align="center"><span class="Estilo26"><span class="Estilo70"><span class="Estilo4 Estilo6  Estilo16 Estilo70"><span class="Estilo4 Estilo16  Estilo6"><span class="Estilo71"><span class="Estilo72"><span class="Estilo59">TIPO IVA: <?echo strtoupper($tipo_fact);?> &nbsp;&nbsp;&nbsp;&nbsp; FORMA DE PAGO: <?echo strtoupper($forma_pago);?>
                      
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PLAN: <?echo strtoupper($plan);?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Descuento: <?echo $porc_dto;?> % </span><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22">
  <!-- <input name="porc_dto2" type="text" class="Estilo22" id="porc_dto2" value="<?echo $porc_dto;?>" size = "5"> -->
          ...
          <tr bgcolor="#9FE1BB">
            <td colspan="5"><div align="left"><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22"><span class="Estilo26"> PRODUCTO: 
                      </span></span></span></span><span class="Estilo4 Estilo6 Estilo16"><span class="Estilo21"><span class="Estilo22"></span></span></span>
              <input name="cod_mercaderia" type="text" class="Estilo22" id="cod_mercaderia" onKeyPress="return verif_caracter(this,event)" value="<?php if (isset($_REQUEST['cod_merca']))   echo $_REQUEST['cod_merca'];?>" size = "15">
					  ...
					  <input name="tipo_precio" type="hidden" value ="<?echo $tipo_precio;?>">
                      ...
                      <input name="Alta" type="image" value= "BUSCAR" src="../../../imagenes/botones/btn_buscar.gif" id = "Alta7">
</span></span></span>
                      
					  
                     &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><a href="control_nro_factura.php?&&nro_factura=<?print("$nro_factura");?>&&fact=<?print("$fact");?>&&tipo_fact=<?print("$tipo_fact");?>&&direccion=<?print("$direccion");?>&&cuit=<?print("$cuit");?>"><img src="../../../imagenes/factura/boton.png" alt="Confirmar" border = "0"></a><span class="Estilo26"></span></div></td>
    </tr>
...
?>
 ...
 <tr>
    <th colspan="5" valign="top" scope="row"><div align="left"> <?include ("refrescar1.php");?>
    </div></th>
    </tr>
 <tr>
   <td width="7%"></td>
...
?>
 ...
 <tr>
    <th colspan="5" valign="top" scope="row"><div align="left"> <?include ("refrescar_vencido.php");?>
    </div></th>
    </tr>
 <tr>
   <td></td>
