...
EXIT;
  ...
  $sql="select * from particulares where cod_socio like '$palabra' or documento like '$palabra' or apellido like '%$palabra%' or nombre like '$palabra%' or telefono like '$palabra%'  or domicilio like '%$palabra%'  order by  cod_socio asc ";
...
if (($ape != "") and ($nom != "")){
  $sql="select * from particulares where  apellido like '$ape%' and nombre like '$nom%'  order by  cod_socio asc  ";
}elseif (($ape != "") and ($nom == "")){
  $sql="select * from particulares where  apellido like '$ape%' order by cod_socio";
}elseif (($ape == "") and ($nom != "")){
  $sql="select * from particulares where  nombre like '$nom%' order by cod_socio";
}

}else
{
    $sql="select * from particulares where cod_socio  like '$palabra' or telefono like '$palabra' limit 1";
...
<table width="800" border="0" cellspacing="0">
  ...
  <tr bordercolor="#FFFFCC" bgcolor="#E6E6E6">
    <td colspan="5"><div align="center"><font color="#FFFFFF" size="2" face="Trebuchet MS"><font color="#000000">LISTADO DE PARTICULARES. Emitido el <?php echo $hoy;?></font></font></div></td>
  </tr>
  <tr bordercolor="#FFFFCC" bgcolor="#CCCCCC">
  
    <td width="179"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS">PART</font></strong></div></td>
...
$telefono = "-";
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td colspan="3" bordercolor="#E8DCFC"><div align="center"></div>        
        <div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS"><a href="../profesionales/entrada_turno_socio.php?cod_socio=<?php print("$cod_socio");?>"></a><a href="convertir_particular.php?cod_socio=<?php print("$cod_socio");?>&&cod_animal=<?php print("$cod_animal");?>&&tipo=part"> CONVERTIR A SOCIO</a></font></strong></div></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td colspan="3" bordercolor="#E8DCFC"><div align="center"><strong><font face="Trebuchet MS"> <a href="pagos_multiples.php?cod_socio=<?php print("$cod_socio");?>" class="Estilo5"></a></font></strong></div></td>
    </tr>
...
<?php }?>
	...
	<tr bgcolor="#EBEBEB">
	  <td bgcolor="#EBEBEB"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS"><a href="../hc/lista_espera.php?cod_socio=<?php print("$cod_socio");?>&&tipo=part">LISTA DE ESPERA</a></font></strong></div></td>
	  <td valign="top"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS"><a href="../hc/entrada_hc.php?cod_socio=<?php print("$cod_socio");?>&&tipo=part">HISTORIA CLINICA</a> - <a href="../hc/entrada_hc_imprimir.php?cod_socio=<?php print("$cod_socio");?>&&tipo=part">IMPRIMIR</a></font></strong></div></td>
	  <td colspan="3" valign="top"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS"><a href="../profesionales/entrada_turno_socio.php?cod_socio=<?php print("$cod_socio");?>&&cod_animal=<?php print("$cod_animal");?>&&tipo=part">SOLICITAR TURNO PELUQUERIA</a></font></strong></div></td>
  </tr>
	<tr bgcolor="#EBEBEB">
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS">AGREGAR MASCOTA </font></div></td>
          <td valign="top"><div align="left"><font size="2" face="Trebuchet MS"><a href="agregar_mascota.php?cod_socio=<?php print("$cod_socio");?>&&cod_animal=<?php print("$cod_animal");?>&&tipo = "part"> <img src="../../imagenes/office//1274.ico" alt="Borrar" border = "0"></a></font></div>            <div align="center"></div></td>
