...
<?php $cod_socio=$_REQUEST["cod_socio"];
...
$nuevo_cod_socio=($result->fields["cod_socio"] + 1);
...
<table width="850" border="0" cellspacing="0">
    ...
    <tr bordercolor="#FFFFFF">
      <td height="30" colspan="4" bgcolor="#CCCCCC"><div align="center"><strong>CAMBIAR PARTICULAR A SOCIO. ESCRIBA LA CONTRASE&Ntilde;A </strong></div>        
        <div align="center"></div></td>
  </tr>
    <tr align="center" bordercolor="#FFFFFF">
      <td height="24" colspan="4"><font color="#000000" size="2">
        NRO SOCIO
        <input name="nuevo_cod_socio" type="text" id="nuevo_cod_socio" onKeyPress="return verif_caracter(this,event)" value="<?php echo $nuevo_cod_socio;?>"  >
      </font></td>
    </tr>
    <tr align="center" bordercolor="#FFFFFF">
