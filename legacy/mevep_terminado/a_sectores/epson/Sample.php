...
$nRet = $oWSpooler->if_write("@PrintLineItem|Mouse Genius XScrol|1.0|0.01|10.50|M|0.0|0|T");


$nRet = $oWSpooler->if_write("@TotalTender|Efectivo|0.01|T|0");
