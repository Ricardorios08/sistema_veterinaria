...
<table width="113%" height="58" border="0">
  ...
  <tr bordercolor="#FFFFCC" bgcolor="#FFFFFF">
    <td height="20" colspan="7" valign="top"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif">INVENTARIO VALORIZADO AL 31 DE AGOSTO DE 2008. Emitido el <?echo $hoy;?> </font></div></td>
  </tr>
...
$sql1="select * from existencias_ago_inicial order by cod_mercaderia";
...
if ($cantidad_existente << 0){?>
    ...
    <tr bgcolor="#FFFFFF"><td height="20"><div align="center"><font color="#000000" size="2"><?print("$cod_mercaderia");?></font></div></td>
...
<td><div align="center"><font color="#000000" size="2"><?print("$cantidad_existente");?></font></div></td>
...
<td><div align="center"><font color="#000000" size="2">$ <?ECHO NUMBER_FORMAT($total,2);?></font><font color="#000000"></font></div></td>
   ...
   <?}else{?>
      <blink> <tr bgcolor="#FFFFFF"><td height="20"><div align="center"><font color="#000000" size="2"><?print("$cod_mercaderia");?></font></div></td>
    <td><div align="left"><font color="#000000" size="2"><?print("$descripcion");?></font></div></td>
    <td><div align="center"><font color="#000000" size="2"><?print("$presentacion");?></font></div></td>
<td><div align="center"><font color="#000000" size="2"><?print("$lote");?></font></div></td>
<td><div align="center"><font color="#000000" size="2"><?print("$cantidad_existente");?></font></div></td>
...
?>
 ...
 <tr bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td colspan="3"><div align="right"><font face="Arial, Helvetica, sans-serif"><strong>TOTAL INVENTARIO</strong></font> <font color="#000000"><strong>$ <?echo  number_format($total_existencia,2);?></strong></font></div></td>
    </tr>
</table>
