...
<table width="134%" height="127" border="0">
  <!--DWLayoutTable-->
  <tr valign="middle" bgcolor="#000099">
    <td height="32" colspan="13"><div align="center"><span class="Estilo5"><span class="Estilo1"><span class="Estilo3">Listado de Facturas Vendidas en Proveeduria. Emitidas al: </span><?ECHO $hoy;?></span> </span></div></td>
  </tr>
  <tr bgcolor="#E1F2EF">
    ...
    <td width="7%"><div align="center"><span class="Estilo6 Estilo2  Estilo5">Bruto</span></div></td>
    ...
    <td width="5%"><div align="center"><span class="Estilo6 Estilo2  Estilo5"><span class="Estilo6">Factura</span></span></div></td>
...
?>
  <tr>
    ...
    <td>
      <div align="center" class="Estilo6"><font color="#000000" size="2"><a href="../buscar/factura_papel.php?tipo_fact=<?print("$tipo_fact");?>&&nro_factura=<?print("$nro_factura");?>&&sigla=<?print("$sigla");?>&&cant_bioq=<?print("$cant_bioq");?>&&cant_ordenes=<?print("$cant_ordenes");?>&&fecha=<?print("$fecha");?>&&total=<?print("$total");?>&&iva=<?print("$iva");?>"><img src="../../../imagenes/office//330.ico" alt="Imprimir" width="18" height="16" border = "0" target= "_top"></a></font> </div></td>
    <td><div align="center"><font color="#000000" size="2"><a href="detalle_ventas.php?nro_factura=<?print("$nro_factura");?>"><img src="../../../imagenes/office//009.ico" alt="Imprimir Detalle" width="17" height="16" border = "0" target= "_top"></a></font></div></td>
  </tr>
