...
<table width="103%" border="0">
    <tr align="center" bordercolor="#FFFFFF" bgcolor="#FFFFFF"> 
      <td height="31" colspan="3"><font color="#000000" face="Arial, Helvetica, sans-serif"><strong>FICHA PROVEEDOR </strong><font size="2">- Emitido el: <?echo $hoy;?> </font></font></td>
  </tr>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
      ...
      <td colspan="2"><strong><?print("$tipo_iva");?> </strong></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
