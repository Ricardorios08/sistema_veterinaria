...
$porc_dto=strtoupper($result6->fields["porc_dto"]);
$neto_gravado=strtoupper($result6->fields["neto_gravado"]);
$iva=strtoupper($result6->fields["iva"]);
$neto=strtoupper($result6->fields["neto"]);
...
<table width="103%" border="0">
  <tr bgcolor="#C4D7E6" class="Estilo26">
    <td colspan="9" scope="col"><span class="Estilo6 Estilo2 Estilo1"><span class="Estilo46">Pddddlan: <span class="Estilo47 Estilo48"><?echo $plan;?>  Forma Pago: <?echo $forma_pago;?></span></span></span></td>
  </tr>
...
<table width="103%" border="0">
  ...
  $ <?echo round($bruto,2);?></span></td>
    <td width="19%" scope="col"><span class="Estilo76">Descuento $ <?echo round($descuento,2);?></span></td>
    ...
    <td width="25%" colspan="4" scope="col"><strong><span class="Estilo76">
       TOTAL $ <?echo number_format($neto,2);?></span></td>
  </tr>
<?
