...
$porc_dto= round(($descuento / $bruto)*100,2);
...
$nro_factura_afectada;
 ...
 echo  $sql3 = "SELECT * FROM `ventas_detalle`  WHERE  `nro_factura` = '$nro_factura_afectada' and tipo_fact = '$tipo_fact_afectado'";
...
$nuevo_total = $cantidad_a_guardar * $precio_unitario;
$sql = "UPDATE `notacredito_deta_temp` SET `cantidad` = '$cantidad_a_guardar' , `total` = '$nuevo_total' WHERE `cod_detalle` = '$cod_detalle1'";
mysql_query($sql);
