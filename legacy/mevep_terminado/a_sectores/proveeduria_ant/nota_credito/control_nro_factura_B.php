...
.Estilo30 {color: #000000; font-family: Arial, Helvetica, sans-serif; }
.Estilo32 {font-weight: bold; font-family: Arial, Helvetica, sans-serif;}
-->
 </style>
<body onload = "on_load ()">
<?
...
$fecha_guardar=strtoupper($result->fields["fecha"]);

$dia = substr($fecha_guardar,8,2);
$mes= substr($fecha_guardar,5,2);
$anio= substr($fecha_guardar,0,4);
...
$porc_dto=strtoupper($result->fields["porc_dto"]);
...
<table width="95%" border="0">
  <!--DWLayoutTable-->
        <tr bgcolor="#000099"><td width="32" valign="middle"><div align="center" class="Estilo4 Estilo7 Estilo10 Estilo21 Estilo16"></div>
        ...
        <td width="73" valign="middle"><div align="center"><span class="Estilo11 Estilo4 Estilo7 Estilo10 Estilo21 Estilo16">Presentaci&oacute;n</span></div>          <div align="center"><span class="Estilo11 Estilo4 Estilo7 Estilo10 Estilo21 Estilo16"> </span></div>          <div align="center"><span class="Estilo11 Estilo4 Estilo7 Estilo10 Estilo21 Estilo16"> </span></div></td>
        <td width="54"><div align="center" class="Estilo11 Estilo21 Estilo16"><span class="Estilo11 Estilo4 Estilo7 Estilo10 Estilo21 Estilo16">Lote</span></div></td>
        ...
        <td width="81"><div align="center"><span class="Estilo11 Estilo21 Estilo16"><span class="Estilo4">Pr. Unit. </span></span></div></td>
        <td width="80"><div align="center"><span class="Estilo11 Estilo21 Estilo16"><span class="Estilo4">Total</span></span></div></td>
      </tr>
...
?><tr bgcolor="#E8DCFC">
    <td scope="col"><div align="center" class="Estilo7 Estilo16 Estilo4"><span class="Estilo40 Estilo17  Estilo14"><?echo $cantidad;?></span></div></td>

    <td colspan="4" valign="top" scope="col"><div align="center" class="Estilo17"  ">
          <div align="left" ><?echo $cod_mercaderia. " - ".$descripcion?></div>
    </div></td>
    <td valign="top" scope="col"><div align="center" class="Estilo17"><?echo $presentacion;?></div>      <div align="center" class="Estilo17"></div>      <div align="center" class="Estilo17"></div></td>
    <td scope="col"><div align="right" class="Estilo40 Estilo14 Estilo17 Estilo7 Estilo16 Estilo4">
      <div align="center"><?echo $lote1;?></div>
    </div></td>
    <td colspan="2" scope="col"><div align="right" class="Estilo40 Estilo14 Estilo17 Estilo7 Estilo16 Estilo4">
      <div align="right"><?echo $mes_lote." - ".$anio_lote;?></div>
    </div></td>
   
    <td><div align="right" class="Estilo17"><?echo number_format($precio_actualizado,3);?></div></td>
    <td><div align="right"><span class="Estilo17"><?echo round($total_renglon,2);?></span></div></td>
    </tr>
...
<tr bgcolor="#E6E6E6">
  <td colspan="3" scope="col"><div align="center" class="Estilo16"><span class="Estilo32">SubTotal: $ <span class="Estilo30">
  </span></span></div>    
  <div align="right" class="Estilo16"></div></td>
  <td colspan="3" scope="col"><div align="right" class="Estilo16">
    <div align="center"><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4">Descuento: $ <span class="Estilo32"><span class="Estilo30">
    </span></span></span></span></strong></span></div>
  </div></td>
  <td colspan="4" scope="col"><div align="right" class="Estilo16"></div>    <div align="right" class="Estilo16"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"></span></span></div></td>
  <td><div align="center"><span class="Estilo16"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><strong><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><span class="Estilo32"><span class="Estilo30"><strong>TOTAL: $ <strong> </strong> </strong>
  </span></span></span></strong></span></strong></span></span></div></td>
  </tr>
<tr bgcolor="#E6E6E6">
  <td colspan="3" scope="col"><div align="center"><span class="Estilo16"><span class="Estilo32"><span class="Estilo30">
      <input name="subtotal" type="text" id ="subtotal2" onKeyPress="return verif_caracter(this,event)" value="<?echo number_format($subtotal,2);?>" size="7">
  </span></span></span></div></td>
  <td colspan="3" scope="col"><div align="center"><span class="Estilo16"><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><span class="Estilo32"><span class="Estilo30">
      <input name="descuento" type="text" id ="descuento2" onKeyPress="return verif_caracter(this,event)" value="<?echo number_format($desc_fact,2);?>" size="7">
  </span></span></span></span></strong></span></span></div></td>
  <td colspan="4" scope="col"><!--DWLayoutEmptyCell-->&nbsp;</td>
  <td><div align="center"><span class="Estilo16"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><strong><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><span class="Estilo32"><span class="Estilo30">
...
<tr bgcolor="#E6E6E6">
  <td colspan="2" valign="middle" scope="col"><div align="right" class="Estilo16"></div>    <div align="right" class="Estilo16"></div>    <div align="center" class="Estilo16"><span class="Estilo32">SubTotal: $ 
  </span></div></td>
  <td colspan="2" valign="middle" scope="col"><div align="center" class="Estilo16"><span class="Estilo4"><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><strong>Desc. $ 
  </strong></span></strong></span></span></div></td>
  <td colspan="4" valign="middle" scope="col"><div align="center" class="Estilo16"><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><span class="Estilo4"><strong>Neto Grav. $ 
  </strong></span></span></strong></span></div></td>
  <td colspan="2" scope="col"><div align="center" class="Estilo16"><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4">IVA: $ 
  </span></span></strong></span></div></td>
  <td scope="col"><div align="right" class="Estilo16"></div>    
    <div align="center" class="Estilo16"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><strong>TOTAL: $ 
    </strong></span></span></div></td>
  </tr>
<tr bgcolor="#E6E6E6">
  <td colspan="2" valign="middle" scope="col"><div align="center" class="Estilo16"><span class="Estilo4"><strong><strong><span class="Estilo30">
  ...
  <td colspan="2" valign="middle" scope="col"><div align="center" class="Estilo16"><span class="Estilo4"><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><strong><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><strong><span class="Estilo30">
      <input name="descuento" type="text" id ="descuento23" onKeyPress="return verif_caracter(this,event)" value="<?echo number_format($desc_fact,2);?>" size="7">
  </span></strong></span></strong></span></strong></span></span></div></td>
  <td colspan="4" valign="middle" scope="col"><div align="center" class="Estilo16"><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><span class="Estilo4"><strong><strong><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><strong><span class="Estilo30">
  ...
  </span></strong></span></strong></strong></span></span></strong></span></div></td>
  <td colspan="2" scope="col"><div align="center" class="Estilo16"><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><span class="Estilo4"><strong><strong><strong><span class="Estilo30">
      <input name="iva_fact1" type="text" id ="descuento2222" onKeyPress="return verif_caracter(this,event)" value="<?echo number_format($iva_fact,2);?>" size="7">
  </span></strong></strong></strong></span></span></span></strong></span></div></td>
  <td scope="col"><div align="center" class="Estilo16"><span class="Estilo14 Estilo39 Estilo38 Estilo28  Estilo4"><strong><strong><span class="Estilo13  Estilo4"><strong><span class="Estilo24"><span class="Estilo4"><strong><span class="Estilo30">
  ...
  </span></strong></span></span></strong></span></strong></strong></span></div></td>
</tr>
<tr>
  <td></td>
  <td width="142"></td>
