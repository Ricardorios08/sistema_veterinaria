...
$fecha20 = $dia1."-".$mes1."-".$anio1;
 ...
 ////////////////////////////////////////////
 $sql1 = "SELECT sum(iva) as iva_facturas FROM ventas_encabezado WHERE fecha = '$fecha1' AND ( cod_operacion = 0 OR cod_operacion = 1 OR cod_operacion = 2 ) and nro_cuenta != 0 ";
$result1 = $db->Execute($sql1);

  $iva_facturas=$result1->fields["iva_facturas"];

  $sql2 = "SELECT sum(iva) as iva_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cuenta != '0'";
$result2 = $db->Execute($sql2);
  $iva_nc=$result2->fields["iva_nc"];
$iva = $iva_facturas - $iva_nc;

$sql1 = "SELECT sum(neto) as neto FROM ventas_encabezado WHERE fecha = '$fecha1' AND ( cod_operacion = 0 OR cod_operacion = 1 OR cod_operacion = 2) and nro_cuenta != 0 and forma_pago = 'CTA/CTE'";
$result1 = $db->Execute($sql1);
 $neto=$result1->fields["neto"];

$sql2 = "SELECT sum(neto) as neto_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cuenta != 0 and forma_pago = 'CTA/CTE'";
$result2 = $db->Execute($sql2);
  $neto_nc=$result2->fields["neto_nc"];

$neto = $neto - $neto_nc;

 $sql1 = "SELECT sum(neto) as contado FROM ventas_encabezado WHERE fecha = '$fecha1' AND ( cod_operacion = 0 OR cod_operacion = 1 OR cod_operacion = 2) and nro_cuenta != 0 and forma_pago = 'CONTADO'";
$result1 = $db->Execute($sql1);
 $contado=$result1->fields["contado"];

$sql2 = "SELECT sum(neto) as contado_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cuenta != 0 and forma_pago = 'CONTADO'";
$result2 = $db->Execute($sql2);
  $contado_nc=$result2->fields["contado_nc"];

///////////////////// NUEVA PARTE
 $sql1 = "SELECT sum(cheque) as cheque FROM ventas_encabezado WHERE fecha = '$fecha1' AND ( cod_operacion = 0 OR cod_operacion = 1 OR cod_operacion = 2) and nro_cuenta != 0 and forma_pago = 'CONTADO'";
$result1 = $db->Execute($sql1);
 $cheque=$result1->fields["cheque"];

 $sql2 = "SELECT sum(cheque) as cheque_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cuenta != 0 and forma_pago = 'CONTADO'";
$result2 = $db->Execute($sql2);
 $cheque_nc=$result2->fields["cheque_nc"];

  $sql1 = "SELECT sum(neto) as caja FROM ventas_encabezado WHERE ( fecha = '$fecha1' and cod_operacion = 0 and nro_cuenta != 0 and forma_pago = 'CONTADO' and cheque = '0.00') OR ( fecha = '$fecha1' and cod_operacion = 1 and nro_cuenta != 0 and forma_pago = 'CONTADO' and cheque = '0.00') OR (fecha = '$fecha1' and cod_operacion = 2 and nro_cuenta != 0 and forma_pago = 'CONTADO' and cheque = '0.00') ";
$result1 = $db->Execute($sql1);
$caja=$result1->fields["caja"];

 $sql2 = "SELECT sum(neto) as caja_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cuenta != 0 and forma_pago = 'CONTADO'";
$result2 = $db->Execute($sql2);
...
//externos
 ////////////////////////////////////////////
 $sql1 = "SELECT sum(iva) as iva_facturas FROM ventas_encabezado WHERE fecha = '$fecha1' AND ( cod_operacion = 0 OR cod_operacion = 1 OR cod_operacion = 2 ) and nro_cliente != 0 ";
$result1 = $db->Execute($sql1);

$iva_facturas=$result1->fields["iva_facturas"];

 $sql2 = "SELECT sum(iva) as iva_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cliente != 0";
$result2 = $db->Execute($sql2);
 $iva_nc=$result2->fields["iva_nc"];

$iva = $iva_facturas - $iva_nc;

$sql1 = "SELECT sum(neto) as neto FROM ventas_encabezado WHERE fecha = '$fecha1' AND ( cod_operacion = 0 OR cod_operacion = 1 OR cod_operacion = 2) and nro_cliente != 0 and forma_pago = 'CTA/CTE'";
$result1 = $db->Execute($sql1);
 $neto=$result1->fields["neto"];

 $sql2 = "SELECT sum(neto) as neto_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cliente != 0 and forma_pago = 'CTA/CTE'";
$result2 = $db->Execute($sql2);
  $neto_nc=$result2->fields["neto_nc"];

$neto = $neto - $neto_nc;

 $sql1 = "SELECT sum(neto) as contado FROM ventas_encabezado WHERE fecha = '$fecha1' AND ( cod_operacion = 0 OR cod_operacion = 1 OR cod_operacion = 2) and nro_cliente != 0 and forma_pago = 'CONTADO'";
$result1 = $db->Execute($sql1);
 $contado=$result1->fields["contado"];

 $sql2 = "SELECT sum(neto) as contado_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cliente != 0 and forma_pago = 'CONTADO'";
$result2 = $db->Execute($sql2);
  $contado_nc=$result2->fields["contado_nc"];

 ///////////////////// NUEVA PARTE
 $sql1 = "SELECT sum(cheque) as cheque FROM ventas_encabezado WHERE fecha = '$fecha1' AND ( cod_operacion = 0 OR cod_operacion = 1 OR cod_operacion = 2) and nro_cliente != 0 and forma_pago = 'CONTADO'";
$result1 = $db->Execute($sql1);
 $cheque=$result1->fields["cheque"];

$sql2 = "SELECT sum(cheque) as cheque_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cliente != 0 and forma_pago = 'CONTADO'";
$result2 = $db->Execute($sql2);
 $cheque_nc=$result2->fields["cheque_nc"];

 $sql1 = "SELECT sum(neto) as caja FROM ventas_encabezado WHERE (fecha = '$fecha1' AND cod_operacion = 0 and nro_cliente != 0 and forma_pago = 'CONTADO' and cheque = '0.00') OR (fecha = '$fecha1' AND cod_operacion = 1 and nro_cliente != 0 and forma_pago = 'CONTADO' and cheque = '0.00') OR (fecha = '$fecha1' AND cod_operacion = 2 and nro_cliente != 0 and forma_pago = 'CONTADO' and cheque = '0.00')";
$result1 = $db->Execute($sql1);
 $caja=$result1->fields["caja"];

$sql2 = "SELECT sum(contado) as caja_nc FROM ventas_encabezado WHERE fecha = '$fecha1' AND cod_operacion = '3' and nro_cliente != 0 and forma_pago = 'CONTADO'";
$result2 = $db->Execute($sql2);
$caja_nc=$result2->fields["caja_nc"];
