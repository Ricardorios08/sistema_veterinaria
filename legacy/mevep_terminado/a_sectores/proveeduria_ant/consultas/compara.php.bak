...
$sql5="select sum(cantidad) as inventario from stock where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio_lote' and  cod_movimiento = 1";
$result5 = $db->Execute($sql5);
$inventario=strtoupper($result5->fields["inventario"]);

 $sql5="select sum(cantidad) as compras from stock where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio_lote' and cod_movimiento = 2";
$result5 = $db->Execute($sql5);
$compras=strtoupper($result5->fields["compras"]);

$sql5="select sum(cantidad) as nc from stock where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio_lote' and cod_movimiento = 3";
$result5 = $db->Execute($sql5);
$nc=strtoupper($result5->fields["nc"]);

$sql5="select sum(cantidad) as ajp from stock where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio_lote' and cod_movimiento = 4";
$result5 = $db->Execute($sql5);
$ajp=strtoupper($result5->fields["ajp"]);

$sql5="select sum(cantidad) as ventas from stock where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio_lote' and cod_movimiento = 5";
$result5 = $db->Execute($sql5);
$ventas=strtoupper($result5->fields["ventas"]);

$sql5="select sum(cantidad) as ajn from stock where cod_mercaderia like '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote = '$anio_lote' and cod_movimiento = 7";
$result5 = $db->Execute($sql5);
