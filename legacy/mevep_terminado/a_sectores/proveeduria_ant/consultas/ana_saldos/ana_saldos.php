...
?>
<table width="650" height="137" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#000099">
    <td colspan="12"><div align="right"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong> DETALLE COMPOSICION DE SALDO </strong> <?echo $hoy;?> </font></div></td>
  </tr>
  <tr bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td colspan="8"><font face="Arial, Helvetica, sans-serif"><strong><font size="2"><?print("$palabra");?> - <?print("$denominacion");?></font></strong></font></td>
  </tr>
...
<td width="17%"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">AC. SALDO &nbsp;&nbsp;<?echo $pagina;?></font></div></td>
</tr>
...
?>
    <tr><td bgcolor="#E8DCFC"><div align="center"><font size="2"><?print("$fecha_emision");?></font></div></td>
    <td bgcolor="#E8DCFC"><div align="center"><font size="2"><?print("$cod_movimiento");?></font></div></td>
    <td bgcolor="#E8DCFC"><div align="center"><font size="2"><?print("$tipo_fact");?></font></div></td>
    <td bgcolor="#E8DCFC"><div align="center"><font size="2"><?print("$comprobante");?></font></div></td>
	<td bgcolor="#E8DCFC"><div align="right"><font size="2"><?echo number_format($importe_original,2);?></font></div></td>
<td bgcolor="#E8DCFC"><div align="center"><font size="2"><?echo $fecha_pago;?></font></div></td>
	<td bgcolor="#E8DCFC"><div align="right"><font size="2"> <?echo number_format($saldo,2);?></font></div></td>
	<td bgcolor="#E8DCFC"><div align="right"><font size="2"> <?echo number_format($saldo_acumulado,2);?></font></div></td>
</tr>   
...
<table width="103%" height="137" border="0">
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td colspan="8"><div align="center"><font color="#0000FF" face="Arial, Helvetica, sans-serif"><strong><font size="3"><?print("$palabra");?> - <?print("$denominacion");?></font></strong></font></div></td>
  </tr>
...
<tr bgcolor="#C4D7E6">
    <td colspan="8" bgcolor="#000099"><div align="right"><font color="#FFFFFF" size="3"><strong><font face="Arial, Helvetica, sans-serif">TOTAL $ <?echo number_format($saldo_acumulado,2);?></font></strong></font></div></td>
  </tr>
</table>
<?}?>