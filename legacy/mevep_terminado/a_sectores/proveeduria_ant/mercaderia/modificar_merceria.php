...
<FORM name="form" ACTION="modificar_mercaderia.php" METHOD = "POST">
  <table width="103%" border="0">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE"> 
      ...
      <input name="codigo" type="text" id="codigo" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $cod_merca; ?>" size="6" > 
      (Codigo del articulo)
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE">
      ...
      <td bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="descripcion" type="text" id="descripcion" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $descripcion; ?>"  size="35">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
      ...
      <td bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="nombre" type="text"  id="nombre" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $nombre; ?>"  size="35"> 
 ...
 <option value="<?php "$tipo";?>"><?php print("$tipo");?></option>
...
(Tipo de producto)</font></td>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
      ...
      <td bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="presentacion" type="text" id="presentacion2"onKeyPress="return verif_caracter(this,event)" value="<?php  echo $presentacion; ?>"  size="6">
(unidades y magnitud) </font></td>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="factorconver" type="text" id ="factorconver" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $factorconver; ?>" size="20">    
    </font></tr>
  ...
  <option value="<?php "$cadenafrio";?>"><?php print("$cadenafrio");?></option>
  </OPTGROUP>
...
?> 
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="fabricante" type="text" id ="fabricante" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $fabricante; ?>" size="20">    
    </font></tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
...
?>     
<option value="<?php "$cod_tasa";?>"><?php print("$cod_tasa");?></option><?php 
    echo"<option value=''>------</option>";
...
?>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      ...
      <td bgcolor="#E1F2EF"><font size="2" face="Arial, Helvetica, sans-serif">
      <input name="margendif" type="text" id ="margendif" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $margendif; ?>" size="5"> 
