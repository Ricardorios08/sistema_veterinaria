...
switch ($tipo_moneda){
	case "d":{$tipo = "DOLAR";BREAK;}
	case "p":{$tipo = "PESOS";BREAK;}
}
...
$por_iva = "Tasa: ".$cod_tasa. " - Socios.: ".$iva_normal. " - Part.: ".$iva_recargo;
$por_iva1 = $cod_tasa. " - Socios.: ".$iva_normal. " - Part.: ".$iva_recargo;
