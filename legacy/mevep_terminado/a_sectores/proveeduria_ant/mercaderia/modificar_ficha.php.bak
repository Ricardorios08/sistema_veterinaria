  ...
  <tr bgcolor="#FFFFCC">
    <td height="26" colspan="2" valign="top" bgcolor="#E0EDF3"><font color="#000000">
      <?php 
	   ...
	   ?>
    <?php echo "  -  ";?> Planilla de Recepci&oacute;n N&ordm;</font>: <font color ="#006633"><strong><strong><font color="#006633"><strong><strong><font color="#000000"><strong>
<input type = "hidden" name = "nro_recibo" id="nro_recibo"size = "15" value="<?php echo $nro_recibo;?>" onKeyPress="return verif_caracter(this,event)">
<?php echo " (".$nro_recibo.") ";?></strong></font></strong></strong></font></strong></strong></font><font color="#000000">&nbsp; Operador:
...
</font> <?php echo "(".$nombre_operario.")";?> <font color="#000000">&nbsp;    </font></td>
  </tr>


  <input type = "hidden" name = "operario" id="operario" size = "15" value="<?php echo $operario;?>" onKeyPress="return verif_caracter(this,event)">
<?php echo "(".$operario.") ";?><?php echo $nombre_operario;?>
...
?>
            <font color="#006633"><strong><strong><font color="#006633"><strong><strong> <font color="#006633"><strong><strong><strong><?php echo $nombre_laboratorio." (".$nro_laboratorio.")";?></strong></strong></strong></font></strong></strong></font></strong></strong></font> </strong></font><font color="#000000">Observaciones:</font>
    ...
    <a href="imprimir.php?fecha=<?php print("$fecha");?>  && nro_laboratorio=<?php print("$nro_laboratorio");?> && observaciones=<?php print("$observaciones");?> && nro_recibo=<?php print("$nro_recibo");?>">IMPRIMIR</a>
</table>
...
?>
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td><div align="center"><?php print $os." (".$nro_os1.")";?></div></td>
    <td><div align="center"><?php print $cantidad;?></div></td>
<td><a href="borra.php?id=<?php print("$nro_os1");?> && id1=<?php print("$cantidad");?> && nro_laboratorio=<?php print("$nro_laboratorio");?> && bandera_mod=<?php print("$bandera_mod");?> && observaciones=<?php print("$observaciones");?> && nro_recibo=<?php print("$nro_recibo");?>">[Eliminar]</a></td>
...
?>
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    <td><div align="center"><?php print $os." (".$nro_os1.")";?></div></td>
    <td><div align="center"><?php print $cantidad;?></div></td>
<td><a href="borra.php?id=<?php print("$nro_os1");?> && id1=<?php print("$cantidad");?> && nro_laboratorio=<?php print("$nro_laboratorio");?> && observaciones=<?php print("$observaciones");?> && nro_recibo=<?php print("$nro_recibo");?>">[Eliminar]</a></td>
...
?>
 ...
 <font color="#990000" size="4"><strong>TOTAL DE ORDENES:</strong></font><strong><font color="#006699" size="5">(<?php ECho $total;?>) </font></strong> 
</table>
  <?php 
					...
					case "2":
				{
						 ?><input type = "hidden" name = "bandera_mod" id="bandera_mod" size = "15" value="2";? onKeyPress="return verif_caracter(this,event)"><?php 
