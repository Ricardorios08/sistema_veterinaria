...
$cantidad_ingresada= $result2->fields["cantidad_ingresada"]; 
 ...
 echo $sql = "UPDATE `existencia_ago` SET `cantidad_ingresada` = '$cantidad_ingresada' , `cantidad_salida` = '0'  WHERE cod_mercaderia = '$cod_mercaderia' and lote = '$lote' and mes_lote = '$mes_lote' and anio_lote= '$anio_lote' and nro_factura = '$nro_factura'";
mysql_query($sql);
