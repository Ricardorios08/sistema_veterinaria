...
<table width="96%" border="0">
  ...
  <tr bgcolor="#FFFFFF">
    <td height="28" colspan="2"><div align="center"><font color="#000000" face="Arial, Helvetica, sans-serif"><strong>INFORME DE COMPRA</strong>. Emitido el <?echo $hoy=date("d/m/Y");?></font></div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
?>
  <tr bgcolor="#FFFFFF">
    <td height="20" colspan="2" scope="col"><div align="left" class="Estilo6 Estilo7"><font size="2" face="Arial, Helvetica, sans-serif"><span class="Estilo28"><?echo $cod_mercaderia. " - ".$descripcion;?></span></font></div></td>
    ...
    <td scope="col"><div align="center" class="Estilo9"><font size="2" face="Arial, Helvetica, sans-serif"><span class="Estilo28"><?echo $cantidad;?></span></font></div></td>
	    <td scope="col"><div align="center" class="Estilo9"><font size="2" face="Arial, Helvetica, sans-serif"><span class="Estilo26"><?echo $lote;?></span></font></div></td>
			...
			<td scope="col"><div align="right" class="Estilo9 Estilo41 Estilo14">$ <?echo number_format($total,2);?></div></td>
  </tr>
<?
...
<tr bgcolor="#FFFFFF">
    <td width="23%" height="21" scope="col"><div align="right" class="Estilo9">
      <div align="center">Sub Total  $ <span class="Estilo7 Estilo41  Estilo6"><span class="Estilo9"><?echo number_format($subtotal,2);?></span></span> </div>
    </div></td>
    <td width="20%" scope="col"><div align="center"><span class="Estilo9">Descuento $ <span class="Estilo7 Estilo41  Estilo6"><?echo number_format($descuento,2);?></span> </span></div></td>
    <td width="14%" scope="col"><div align="center" class="Estilo9"></div>      
    <div align="center" class="Estilo15"><span class="Estilo9">Retenci&oacute;n: $ <?echo number_format($retencion,2);?></span></div></td>
    <td height="21" colspan="2" scope="col"><div align="center"><span class="Estilo9">      IVA: $ <?echo number_format($iva,2);?>
       </span></div></td>
    <td height="21" colspan="4" scope="col"><div align="center"></div>      
    <div align="center"><span class="Estilo41 Estilo14 Estilo9">Total $ </span><span class="Estilo11 Estilo41 Estilo14"><?echo number_format($total_fact,2);?></span></div></td>
  </tr>
<tr bgcolor="#FFFFFF">
  <td height="21" scope="col"><div align="right" class="Estilo41 Estilo14 Estilo9">
    <div align="center">Cantidad Items: <span class="Estilo14 Estilo41 Estilo11"><strong><?echo $total_item;?></strong></span> </div>
  </div></td>
  <td height="21" colspan="8" scope="col"><span class="Estilo9">Cantidad de Mercaderia Ingresada: <?echo $total_cantidad;?></span></td>
  </tr>
</table>
