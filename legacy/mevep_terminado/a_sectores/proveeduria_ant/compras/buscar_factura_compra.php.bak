...
<table width="135%" height="153" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#E6E6E6">
    <td height="25" colspan="12"><div align="center"><font color="#FFFFFF" size="2"><font color="#000000" face="Arial, Helvetica, sans-serif">LISTADO DE FACTURAS DE COMPRAS. Emitido el <?echo $hoy;?></font></font></div></td>
  </tr>
...
switch ($buscador_rapido)
{
	...
	{
		?>
  <td bgcolor="#E8DCFC"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$nro_factura");?></font></div></td>
    <td bgcolor="#E8DCFC"><div align="left"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$denominacion");?></font></div></td>
    <td bgcolor="#E8DCFC"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$fecha");?></font></div></td>
    <td bgcolor="#E8DCFC"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$descuento");?></font></div></td>
    <td bgcolor="#E8DCFC"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$bonificacion");?></font></div></td>
	<td bgcolor="#E8DCFC"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$subtotal");?></font></div></td>
	<td bgcolor="#E8DCFC"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$iva");?></font></div></td>
	<td bgcolor="#E8DCFC"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$total");?></font></div></td>
    ...
    <td bordercolor="#E8DCFC" bgcolor="#E8DCFC"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"> <a href="clientes/ficha.php?id=<?print("$cuenta");?>"><IMG SRC="../../imagenes/office/005.ico" alt="Ficha" border = "0"></a></font></div></td>
  </tr>
  <?
...
case "1":
	  {
	?>
  <td bgcolor="#FFFFFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$nro_factura");?></font></div></td>
    <td bgcolor="#FFFFFF"><div align="left"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$denominacion");?></font></div></td>
    <td bgcolor="#FFFFFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$fecha");?></font></div></td>
    <td bgcolor="#FFFFFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$descuento");?></font></div></td>
    <td bgcolor="#FFFFFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$bonificacion");?></font></div></td>
	<td bgcolor="#FFFFFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$subtotal");?></font></div></td>
	<td bgcolor="#FFFFFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$iva");?></font></div></td>
	<td bgcolor="#FFFFFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?print("$total");?></font></div></td>


    <td bordercolor="#E8DCFC" bgcolor="#FFFFFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"> <a href="clientes/ficha.php?id=<?print("$id");?>"><IMG SRC="../imagenes/office/005.ico" alt="Ficha" border = "0"></a></font></div></td>
  </tr>
  <?
