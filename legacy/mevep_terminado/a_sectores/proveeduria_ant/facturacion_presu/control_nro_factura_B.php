...
$sql2 = "SELECT * FROM `ventas1_encab_temp_pc2`  WHERE  `nro_factura` = $nro_factura and tipo_fact = '$fact'";
...
<table width="95%" border="0">
  <tr bgcolor="#E6E6E6">
    <td height="32" colspan="3" ><div align="center" class="Estilo15" >
      ...
      </span></span></span>REVISAR  FACTURA E IMPRIMIR (PRESUPUESTO)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="button" value="&lt; Corregir &gt;" onKeyPress="history.back()" onCLICK="history.back()" id ="boton" style="font-family: Verdana; font-size: 14 pt">
      </div>
    </div> </td>
    </tr>
  <tr bgcolor="#C1F2FF">
    <td bgcolor="#99CCFF"><div align="right" class="Estilo4 Estilo16"><span class="Estilo17  Estilo14">N&ordm; FACTURA EMITIDO POR SISTEMA: </span></div></td>
    <td colspan="2" bgcolor="#E6E6E6"><span class="Estilo14 Estilo4"><?echo $fact;?> - <?echo $nro_factura;?> </span></td>
  </tr>
  <tr bgcolor="#C1F2FF">
    <td width="45%" bgcolor="#99CCFF"><div align="right" class="Estilo17"><span class="Estilo18">En caso de no coincidir Cambiar por:
      </span></div></td>
    <td colspan="2" bgcolor="#E6E6E6"><span class="Estilo14 Estilo17">
  ...
  <tr bgcolor="#C1F2FF">
    <td bgcolor="#99CCFF"><div align="right" class="Estilo17"><span class="Estilo18">
...
<input name="leyenda1" type="text" id="leyenda12" size="30" maxlength="30"  onKeyPress="return verif_caracter(this,event)">      
  ...
  <tr bgcolor="#C1F2FF">
    <td bgcolor="#99CCFF"><div align="right" class="Estilo17">Cantidad de Cuotas</div></td>
    <td colspan="2" bgcolor="#E6E6E6"><span class="Estilo14 Estilo17">
...
include("../../../conexiones/config_pro.php");
 $sql = "SELECT * FROM `ventas1_deta_temp_pc2`  WHERE  `nro_factura` = $nro_factura and tipo_fact = '$fact'";
...
$precio_bruto = round($precio_neto * $cantidad,3);
...
$precio_actualizado = round($precio_actualizado + $iva_articulo,3);
 ...
 $precio_actualizado;
 $total = round($precio_actualizado * $cantidad,3);
$desc_articulo = ($total * $porc_dto)/100; // descuento por articulo 
...
$sql_ventas = "UPDATE `ventas1_encab_temp_pc2` SET `plan` = '$plan' WHERE nro_factura = $nro_factura ";
...
?><tr bgcolor="#E8DCFC">
    ...
    <td scope="col"><div align="right" class="Estilo40 Estilo14 Estilo17 Estilo7 Estilo4 Estilo16">
      <div align="right"><?echo $precio_actualizado;?></div>
    </div></td>
    <td scope="col"><div align="right" class="Estilo40 Estilo14 Estilo17 Estilo7 Estilo4 Estilo16">
