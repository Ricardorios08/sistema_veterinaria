...
$sql4 = "SELECT * FROM `ventas1_encab_temp_pc2`  WHERE  `nro_factura` = $nro_factura and tipo_fact = '$fact'";
...
$sql = "SELECT count(nro_factura) as cont from ventas1_deta_temp_pc2";
...
if ($plan == ""){
$sql = "SELECT * FROM `ventas1_encab_temp_pc2`  WHERE  `nro_factura` = $nro_factura and tipo_fact = '$fact'";
$result = $db->Execute($sql);
...
$sql = "UPDATE `ventas1_encab_temp_pc2` SET `plan` = '$plan' WHERE nro_factura = $nro_factura ";
//mysql_query($sql);
...
$sql = "UPDATE `ventas1_encab_temp_pc2c` SET `forma_pago` = '$forma_pago' WHERE nro_factura = $nro_factura  and tipo_fact = '$fact'";
//mysql_query($sql);
