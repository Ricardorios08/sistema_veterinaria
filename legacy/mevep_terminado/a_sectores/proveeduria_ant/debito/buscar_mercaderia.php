...
echo $sql="select * from mercaderia order by cod_merca";
}
...
<table width="777" height="62" border="0">
  <tr bordercolor="#FFFFCC" bgcolor="#666666">
    <td colspan="12"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">LISTADO DE MERCADERIA . Emitido el <?php echo $hoy;?> </font></div></td>
  </tr>
...
if ($moneda == "p"){?>
    ...
    <td bgcolor="#9FE1BB"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><?php print("$nombre");?></font></div></td>
    <td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo $tipo_moneda;?></font></div></td>
    ...
    <td bordercolor="#E8DCFC" bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo number_format($en_por_menor_pesos,2);?></font></div></td>
  </tr>
  ...
  <?php }
    ...
    <td bgcolor="#9FE1BB"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><?php print("$nombre");?></font></div></td>
    <td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo $tipo_moneda;?></font></div></td>
    <td bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo number_format($en_empresas_dolar,2);?></font></div></td>

    <td bordercolor="#E8DCFC" bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo number_format($en_regaleria_dolar,2);?></font></div></td>
    <td bordercolor="#E8DCFC" bgcolor="#9FE1BB"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo number_format($en_por_menor_dolar,2);?></font></div></td>
  </tr>
...
?>
    <tr>
      <td height="20" colspan="6" bgcolor="#666666"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">CANTIDAD DE MERCADERIA <?php ECHO $cont;?></font></div></td>
    </tr>
</table>
