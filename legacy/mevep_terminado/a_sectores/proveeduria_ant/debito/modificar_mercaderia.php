...
?>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#EEEEEE"> 
      ...
      <input name="cod_mevep" type="text" id="cod_mevep" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $cod_mevep; ?>" size="5"> 
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
      ...
      <td bgcolor="#9FE1BB"><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="documento" type="text"  id="documento" onKeyPress="return verif_caracter(this,event)" value="<?php echo $documento; ?>"  size="8">
      </font> </td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#A0A7F5"><div align="right"><font size="2" face="Arial, Helvetica, sans-serif">Nº Tarjeta</font></div></td>
      <td bgcolor="#9FE1BB"><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="cbu" type="text"  id="cbu" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $cbu; ?>"  size="20" maxlength="16"> 
        16 digitos (obligatorios)
      </font></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#A0A7F5"><div align="right"><font size="2" face="Arial, Helvetica, sans-serif">Fecha</font></div></td>
      <td bgcolor="#9FE1BB"><input name="monto_descontar2" type="text" id ="monto_descontar3" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $fecha_ingreso;?>" size="10" maxlength="10"></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFCC">
      <td bgcolor="#A0A7F5"><div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Monto a Descontar </font></div></td>
      <td bgcolor="#9FE1BB">
        <input name="monto_descontar" type="text" id ="monto_descontar" onKeyPress="return verif_caracter(this,event)" value="<?php  echo $monto_descontar; ?>" size="5">
		<input name="cod_operacion" type="hidden" value="<?php  echo $cod_oepracion;?>">
