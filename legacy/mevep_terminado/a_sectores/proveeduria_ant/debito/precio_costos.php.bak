...
<table width="650" border="0">
  ...
  <tr>
    ...
    <td width="313" bgcolor="#9FE1BB"><input name="dolar" type="text" id="dolar" size="4" value = "<?echo $dolar;?>"></td>
	  </tr>

  <tr>
    <td width="321" bgcolor="#A0A7F5"><div align="right" class="Estilo2 Estilo3">DOLAR VENTA</div></td>
    <td width="313" bgcolor="#9FE1BB"><input name="dolar1" type="text" id="dolar" size="4" value = "<?echo $dolar1;?>"></td>
	  </tr>

  <tr>
    <td bgcolor="#A0A7F5"><div align="right" class="Estilo4">COSTO</div></td>
    <td bgcolor="#9FE1BB"><input name="costo" type="text" id="costo" size="4" value = "<?echo $costo;?>" ></td>
  </tr>
  <tr>
    <td bgcolor="#A0A7F5"><div align="right" class="Estilo4">EMPRESA</div></td>
    <td bgcolor="#9FE1BB"><input name="empresas" type="text" size="4" value = "<?echo $empresas;?>" ></td>
  </tr>
  <tr>
    <td bgcolor="#A0A7F5"><div align="right" class="Estilo4">REGALERIA</div></td>
    <td bgcolor="#9FE1BB"><input name="regaleria" type="text" id="regaleria" size="4" value = "<?echo $regaleria;?>" ></td>
  </tr>
  <tr>
    <td bgcolor="#A0A7F5"><div align="right" class="Estilo4">POR MENOR </div></td>
    <td bgcolor="#9FE1BB"><input name="por_menor" type="text" id="por_menor" size="4" value = "<?echo $por_menor;?>"></td>
  </tr>
  <tr bgcolor="#CCCCCC">
