...
switch ($tipo_cuenta){
	case "1":{
$sql1="select * from datos_laboratorio where nro_laboratorio like '$busca'";
$result1 = $db_bq->Execute($sql1);
$nombre_laboratorio=strtoupper($result1->fields["nombre_laboratorio"]);
$sigla = $nombre_laboratorio." - ".$busca;
$cuenta = $busca;
break;}

case "2":{

$sql="select * from clientes where cuenta like '$busca'";
...
$cuenta = $busca;
 ...
 $sql = "INSERT INTO recibos1_encab_temp_pro ( `nro_recibo` , `fecha_pago` , `cuenta` , `tipo_cuenta` , `cant_fact` , `importe_pagado` , `periodo` , `anio` , `operador`  ) values ( '$nro_recibo' , '$fecha_guardar' , '$busca' , '$tipo_cuenta' , '$cant_fact' , '$importe_pagado' , '$mes' , '$anio' , '$operador')";
mysql_query($sql);
...
<FORM name="form" ACTION="cobrar_proveeduria1.php" METHOD = "POST">
...
<table width="682" border="0">
         <tr bgcolor="#999999">
           <td width="408" valign="top"><table width="100%" border="0">
             ...
             <tr bgcolor="#E1F2EF">
               <td height="28" colspan="2"><div align="center"><span class="Estilo20">Laboratorio: <?echo $sigla." (".$busca.")";?><br>
	...
	<iframe src="fact_pendientes_prov.php?busca=<?print("$busca");?>&&tipo_cuenta=<?print("$tipo_cuenta");?>" width="302" height="122" align="center"></iframe>
	</td>
         </tr>
  </table>
	   </th>
