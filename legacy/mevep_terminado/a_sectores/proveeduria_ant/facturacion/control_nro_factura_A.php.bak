...
<FORM name="form" ACTION="factura_papel.php" METHOD = "POST">
  ...
  <tr bgcolor="#E6E6E6">
    <td height="32" colspan="2" ><div align="center" class="Estilo15" >
      ...
      <input name="actua" type="submit" id ="button" value="ACTUALIZAR STOCK" onclick="return confirm('Si están todos los datos correctos Actualice STOCK');">
  ...
  <tr bgcolor="#C1F2FF">
    <td width="38%" bgcolor="#C9FADF"><div align="right" class="Estilo17"><span class="Estilo18">En caso de no coincidir Cambiar por:
      </span></div></td>
...
<?if ($forma_pago == "CTA/CTE"){?>
  <tr bgcolor="#C1F2FF">
    ...
    <td colspan="2" bgcolor="#F2FACB"><span class="Estilo14 Estilo17">
      <input name="cantidad_cuotas" type="text" id ="cantidad_cuotas" onKeyPress="return verif_caracter(this,event)" value="1" size="2" maxlength="2">
</span></td>
  </tr>
<?}?>
 ...
 <table width="750" height="68" border="0">
      <!--DWLayoutTable-->
      <tr bgcolor="#C4D7E6">
      ...
      <tr bgcolor="#C4D7E6">
        ...
        <span class="Estilo7 Estilo4 Estilo11  Estilo14 Estilo16">IVA</span><span class="Estilo7 Estilo19  Estilo4 Estilo16">:</span><span class="Estilo7 Estilo4 Estilo17 Estilo14 Estilo16"> <?print("$tipo_fact");?> - Cuit: <?echo $cuit;?> </span><span class="Estilo16"></span></span></td>
