...
$sql = "SELECT * FROM `ventas1_encab_temp`";
...
<table width="850" border="0">
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#FFFFCC"><span class="Estilo22"><?php ECHO $tipo_fact;?> - <?php ECHO $nro_factura;?></span></td>
  </tr>
  <tr>
    <td bgcolor="#FFFF99"><div align="right" class="Estilo14 Estilo19"><strong>OPERADOR</strong></div></td>
    <td colspan="2" bgcolor="#FFFFCC"><span class="Estilo22"><?php ECHO $operador;?></span></td>
  </tr>
  <tr>
    <td bgcolor="#FFFF99"><div align="right" class="Estilo23">CUENTA</div></td>
    <td colspan="2" bgcolor="#FFFFCC"><span class="Estilo22"><?php ECHO $denominacion;?></span></td>
  </tr>
  <tr>
    <td bgcolor="#FFFF99"><div align="right" class="Estilo23">FECHA</div></td>
    <td colspan="2" bgcolor="#FFFFCC"><span class="Estilo22"><?php ECHO $fecha;?></span></td>
  </tr>
  <tr>
    <td height="62" colspan="3" bgcolor="#FFFF99"><div align="center"><span class="Estilo12">¿DESEA ACTUALIZARLA?</span></div></td>
    </tr>
  <tr>
    <td height="21" colspan="2" valign="top" bgcolor="#FFFF99"><div align="right">
      <input name="confirma" type="text" class="Estilo12" size="2" maxlength="2">
	        <input name="fact" type="hidden" value = "<?php echo $tipo_fact;?>">
			<input name="tipo_factura" type="hidden" value = "<?php echo $tipo_fact;?>">
