...
.Estilo81 {font-family: Arial, Helvetica, sans-serif; font-weight: bold; font-size: 12px; }
.Estilo82 {
	font-size: 12px;
	font-weight: bold;
}
.Estilo32 {font-size: 12px}
.Estilo33 {font-family: Arial, Helvetica, sans-serif; color: #000000;}
...
<table width="750" border="0">
  ...
  <tr bgcolor="#CFCFCF" class="Estilo26">
    ...
    <td scope="col"><div align="center" class="Estilo6 Estilo2 Estilo1"><span class="Estilo46"></span></div>      <div align="center" class="Estilo3"><span class="Estilo6"><span class="Estilo46">Descrfffipcion / Mercaderia</span></span></div></td>
...
$id_tasa=strtoupper($result->fields["cod_tasa"]);
...
$subtotal = $suma_total - $desc_factura - $exento; // neto grabado
$iva = ($subtotal * $iva_normal) /100;
$total_factura = $subtotal + $iva + $exento;
}
else
	 {
...
?>
    ...
    <td height="27" scope="col"><div align="left" class="Estilo47 Estilo48"><span class="Estilo26"><?echo $cod_mercaderia. " - ".$descripcion." (".$cant_exis.")";?><?
				if ($id_tasa == 0){
				echo " (EXENTO)"; }
				?></span></div></td>
    ...
    <td scope="col"><div align="center" class="Estilo46"><span class="Estilo26"><?echo $cantidad;?></span></div></td>
	    <td scope="col"><div align="center" class="Estilo46"><span class="Estilo26"><?echo $lote1;?></span></div></td>
		    <td scope="col"><div align="center" class="Estilo46"><span class="Estilo26"><?echo $vto_lote;?>
			
			
			</span></div></td>

    <td scope="col"><div align="right" class="Estilo46 Estilo32"><span class="Estilo33"><?echo $precio_unitario;?></span></div></td>
    <td scope="col"><div align="right" class="Estilo46 Estilo32"><span class="Estilo33"><?echo number_format($total,2);?></span></div></td>
   <td width="4%" bgcolor="#E0EDF3" class="Estilo6"><div align="center">
   <a href="borrar_item.php?cod_detalle=<?print("$cod_detalle");?>&&nro_factura=<?print("$nro_factura");?>&&tipo_fact=<?print("$tipo_fact");?>&&nro_cliente=<?print("$nro_cliente");?>&&matricula=<?print("$matricula");?>&&pasada=1&&forma_pago=<?print("$forma_pago");?>&&dia=<?print("$dia");?>&&mes=<?print("$mes");?>&&anio=<?print("$año");?>&&mes=<?print("$mes");?>&&band=<?print("$band");?>&&operador=<?print("$operador");?>" onclick="return confirm('¿Está seguro de borrar este producto?');"><IMG SRC="../../../imagenes/office/095.ico" alt="Anular"  border = "0"></a>
...
<table width="750" border="0">
		  <tr bgcolor="#CFCFCF" >
    <td width="18%" height="20" scope="col"><div align="center"><span class="Estilo81">Subtotal     
    $ </span></div></td>
    <td width="19%" scope="col"><div align="center"><span class="Estilo81">Descuento $ </span></div></td>
    <td width="8%" scope="col"><div align="center"></div>      <div align="center" class="Estilo82">
      <div align="center"> </div>
    </div></td>
    <td width="9%" scope="col"><div align="center"><span class="Estilo25">Neto Grav.</span></div></td>
    <td width="10%" scope="col"><div align="center" class="Estilo82">
      <div align="center"><span class="Estilo76">IVA $ </span></div>
    </div></td>
    <td width="11%" scope="col"><div align="center"><span class="Estilo25">EXENTO</span></div></td>
    <td width="25%" colspan="4" scope="col"><div align="center"><span class="Estilo82"><strong><span class="Estilo76">
         TOTAL $ </span></span></div></td>
  </tr>
		  <tr bgcolor="#E6E6E6" >
		    <td height="20" scope="col"><div align="center"><span class="Estilo76"><?echo round($suma_total,2);?></span></div></td>
		    ...
		    <td scope="col"><div align="center"><span class="Estilo76"><?echo round($subtotal,2);?></span></div></td>
		    <td scope="col"><div align="center"><span class="Estilo76"><?echo number_format($iva,2);?></span></div></td>
		    <td scope="col"><div align="center"><span class="Estilo76"><?echo round($exento,2);?></span></div></td>
