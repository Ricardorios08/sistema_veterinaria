...
<table width="1089" border="0">
  <tr>
    <td width="596" scope="col"><table width="503" height="137" border="0">
      <!--DWLayoutTable-->
      <tr>
...
include("../../../conexiones/config_pro.php");
echo $sql2 = "SELECT * FROM `ventas1_encab_temp`  WHERE  `nro_factura` = $nro_factura and tipo_fact = '$fact'";
...
//mysql_query($sql);
  ...
  $sql = "INSERT INTO `ventas_encabezado` ( `tipo_fact` , `nro_factura` , `cod_operacion` , `tipo` , `nro_cliente` , `nro_cuenta` , `plan` , `operador` , `denominacion` , `fecha` , `bruto` , `descuento` , `iva` , `retencion` , `neto` , `forma_pago` ) VALUES ( '$fact' , '$nro_factura_nuevo' , '1' , '$tipo_fact' , '$nro_cliente' , '$nro_cuenta' , '$plan' , '$operador' , '$denominacion' , '$fecha' , '$bruto' ,  '$descuento' , '$iva' , '$retencion' , '$total_factura' , '$forma_pago' )";
//mysql_query($sql);
$nro_factura = $nro_factura_nuevo;
break;
	}
...
//mysql_query($sql);
  ...
  $sql = "INSERT INTO `ventas_encabezado` ( `tipo_fact` , `nro_factura` , `cod_operacion` , `tipo` , `nro_cliente` , `nro_cuenta` , `plan` , `operador` , `denominacion` , `fecha` , `bruto` , `descuento` , `iva` , `retencion` , `neto` , `forma_pago` ) VALUES ( '$fact_nuevo' , '$nro_factura' , '1' , '$tipo_fact' , '$nro_cliente' , '$nro_cuenta' , '$plan' , '$operador' , '$denominacion' , '$fecha' , '$bruto' ,  '$descuento' , '$iva' , '$retencion' , '$total_factura' , '$forma_pago' )";
//mysql_query($sql);
$fact = $fact_nuevo;
break;
	}
		...
		case "4":{
 $sql = "INSERT INTO `ventas_encabezado` ( `tipo_fact` , `nro_factura` , `cod_operacion` , `tipo` , `nro_cliente` , `nro_cuenta` , `plan` , `operador` , `denominacion` , `fecha` , `bruto` , `descuento` , `iva` , `retencion` , `neto` , `forma_pago` ) VALUES ( '$fact' , '$nro_factura' , '1' , '$tipo_fact' , '$nro_cliente' , '$nro_cuenta' , '$plan' , '$operador' , '$denominacion' , '$fecha' , '$bruto' ,  '$descuento' , '$iva' , '$retencion' , '$total_factura' , '$forma_pago' )";
//mysql_query($sql);
...
?>
      ...
      <tr>
        ...
        <td width="171" height="28" valign="bottom"><div align="right"><span class="Estilo16"><span class="Estilo22"><span class="Estilo8 Estilo11 Estilo14"><span class="Estilo18"><span class="Estilo14 Estilo22">Fecha:</span> <?echo $fecha_a;?></span></span></span></span></div></td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="320" height="24"><div align="left" class="Estilo15"></div>          <div align="left"></div>          
...
$iva_unitario = ($precio_unitario * 21)/100;
$iva_guardar = $iva_unitario * $cantidad;

$precio_unitario = $precio_unitario + $iva_unitario;
...
?><tr bgcolor="#FFFFFF">
    ...
    <td valign="top" scope="col"><div align="right" class="Estilo40 Estilo14 Estilo17">
        <div align="center"><span class="Estilo28 Estilo22"><?echo number_format($precio_unitario,2);?></span></div>
    </div></td>
    <td valign="top" scope="col"><div align="right" class="Estilo40 Estilo14 Estilo17">
      <div align="center"><span class="Estilo28 Estilo22"><?echo number_format($total,2);?></span></div>
    </div></td>
...
$sql = "UPDATE `ventas_encabezado` SET `bruto` = '$total', `descuento` = '$descuento' , `iva` = '$iva_guardar' , `retencion` = '$retencion', `neto` = '$total_factura' WHERE `tipo_fact` = '$fact' AND `nro_factura` = '$nro_factura'";
//mysql_query($sql);
...
?>
      ...
      <tr>
        ...
        <td><div align="center"><span class="Estilo22 Estilo14"><span class="Estilo28"><span class="Estilo28 Estilo38 Estilo39 Estilo14 Estilo22"><?echo number_format($descuento,2);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span></div></td>
        <td colspan="2"><div align="center"><span class="Estilo22 Estilo14"><span class="Estilo28"></span></span>          <span class="Estilo16 Estilo22"><strong><span class="Estilo22 Estilo14"><span class="Estilo28"><span class="Estilo28 Estilo38 Estilo39 Estilo14 Estilo22">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span></strong></span></div></td>
...
?>
        ...
        <tr>
          ...
          <td colspan="2"><div align="center"><span class="Estilo22 Estilo14"><span class="Estilo28"></span></span> <span class="Estilo16 Estilo22"><strong><span class="Estilo22 Estilo14"><span class="Estilo28"><span class="Estilo28 Estilo38 Estilo39 Estilo14 Estilo22"><? number_format($iva,2);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span></strong></span></div></td>
          <td><div align="center"><span class="Estilo16 Estilo22"><strong><?echo number_format($total_factura,2);?>
                      <?
