...
$result6 = $db_aj->Execute($sql6);
$forma_pago=strtoupper($result6->fields["forma_pago"]);
 $motivo_ajuste=strtoupper($result6->fields["denominacion"]);
...
if (!$result3) die("fallo".$db_aj->ErrorMsg());
...
?>
   ...
   <a href="borrar_item.php?cod_detalle=<?print("$cod_detalle");?>&&nro_factura=<?print("$nro_factura");?>&&tipo_fact=<?print("$tipo_fact");?>&&nro_cliente=<?print("$nro_cliente");?>&&matricula=<?print("$matricula");?>&&pasada=1&&motivo_ajuste=<?print("$motivo_ajuste");?>&&dia=<?print("$dia");?>&&mes=<?print("$mes");?>&&anio=<?print("$año");?>&&mes=<?print("$mes");?>&&band=<?print("$band");?>&&operador=<?print("$operador");?>" onclick="return confirm('¿Está seguro de borrar este producto?');"><IMG SRC="../../../imagenes/office/095.ico" alt="Anular"  border = "0"></a>
...
<table width="103%" border="0">
		  <tr bgcolor="#CFCFCF" >
    <td width="18%" height="20" scope="col"><div align="center" class="Estilo69"><span class="Estilo76">Subtotal     
    $ </span></div></td>
    <td width="19%" scope="col"><div align="center" class="Estilo69"><span class="Estilo76">Descuento $ </span></div></td>
    <td width="17%" scope="col"><div align="center"> <div align="center" class="Estilo69"><span class="Estilo76">Neto Grav.  $ </span> </div></td>
    <td width="21%" scope="col"><div align="center" class="Estilo69"><span class="Estilo76">IVA $ </span></div></td>
    <td width="25%" colspan="4" scope="col"><span class="Estilo69"><strong>
      </span>
      <div align="center" class="Estilo69"><span class="Estilo76">
         TOTAL $ </span></div></td>
  </tr>
		  <tr bgcolor="#E6E6E6" >
