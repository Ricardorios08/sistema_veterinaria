...
$cantidad_recuperada = $cantidad_salida - $cantidad;


$cont = $cont + 1;

 $sql = "UPDATE `existencias` SET `cantidad_salida` = '$cantidad_recuperada' WHERE cod_mercaderia = $cod_mercaderia and mes_lote = '$mes_lote' and anio_lote = '$anio_lote' and lote = '$lote'";
$result3 = $db_pro->Execute($sql);

 $sql = "DELETE FROM `stock` WHERE nro_comprobante = $nro_factura and cod_movimiento = 7 and tipo_fact = 'I'";
$result3 = $db_pro->Execute($sql);
...
$sumatoria = 0;
 ...
 $sql = "DELETE FROM `ventas_detalle` WHERE nro_factura = $nro_factura and tipo_fact = 'I'";
$result3 = $db_aj->Execute($sql);
 $sql = "DELETE FROM `ventas_encabezado` WHERE nro_factura = $nro_factura and tipo_fact = 'I'";
$result3 = $db_aj->Execute($sql);
...
$leyenda = "Se elimino el informe y se reestablecieron las existencias y stock";
