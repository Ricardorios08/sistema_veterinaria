...
$sql = "SELECT * FROM `ventas1_encab_temp_aju`";
...
<table width="571" border="0">
  <!--DWLayoutTable-->
  <tr>
    <td height="60" colspan="3" bgcolor="#FF0000"><div align="center" class="Estilo9"><BLINK><strong>AJUSTE SIN ACTUALIZAR </strong></BLINK></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="126" bgcolor="#FFFF99"><div align="right" class="Estilo13 Estilo10"><strong>N&ordm; AJUSTE </strong></div></td>
