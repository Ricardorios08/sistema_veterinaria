...
<table width="850" border="0" cellspacing="0">
    ...
    <tr bordercolor="#FFFFFF">
      <td height="30" colspan="2" bgcolor="#CCCCCC"><div align="center"><strong>INGRESO SOCIO NUEVO</strong></div></td>
...
<input name="anio_nac" type="text" id="anio_nac"onKeyPress="return verif_caracter(this,event)" value="<?php echo $anio_nac;?>"  size="4" maxlength="4" tabindex="22">
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td colspan="2" bgcolor="#CCCCCC"><div align="center"><strong>DATOS CONVENIO</strong></div></td>
  <tr bordercolor="#FFFFFF">
    ...
    <td><strong><font color="#000000" size="2">
      <input name="importe_cuota" type="text" id="importe_cuota"onKeyPress="return verif_caracter(this,event)" value="<?php echo $importe_cuota;?>"  size="12" maxlength="cod_postal" tabindex="23">
    </font></strong></td>
  <tr bordercolor="#FFFFFF">
    ...
    <td><font color="#000000" size="2"><strong><font color="#000000" size="2"><strong><font color="#000000" size="2">
      <input name="dia_ingreso" type="text" id="dia_ingreso"onKeyPress="return verif_caracter(this,event)" value="<?php echo $dia_ingreso;?>"  size="2" maxlength="2" tabindex="24">
  / <strong><font color="#000000" size="2">
  <input name="mes_ingreso" type="text" id="mes_ingreso"onKeyPress="return verif_caracter(this,event)" value="<?php echo $mes_ingreso;?>"  size="2" maxlength="2" tabindex="25">
  </font></strong>/<strong><font color="#000000" size="2">
  <input name="anio_ingreso" type="text" id="anio_ingreso"onKeyPress="return verif_caracter(this,event)" value="<?php echo $anio_ingreso;?>"  size="4" maxlength="4" tabindex="26">
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td><div align="right">Modo de Pago</div></td>
    <td><font color="#000000" size="2">
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td><strong><font color="#000000" size="2">
      <input name="ruta" type="text" id="ruta"onKeyPress="return verif_caracter(this,event)" value="<?php echo $ruta;?>"  size="12" maxlength="cod_postal" tabindex="27">
    </font></strong></td>
  <tr bordercolor="#FFFFFF">
    <td height="26" colspan="2"><!--DWLayoutEmptyCell-->&nbsp;</td>
    <td><div align="right">Cobrador</div></td>
    <td><strong><font color="#000000" size="2">
...
echo"<option value=$cod_plan>$cod_cobrador - $nombre_cobrador</option>";
$result->MoveNext();
	}
echo"</select>";
?>
  ...
  <tr bordercolor="#FFFFFF">
    <td height="26" colspan="2"><div align="center"><font color="#000000" size="2">
        <input type="Submit" name="Submit" id ="Submit" value="GUARDAR SOCIO" tabindex="29" onClick="return confirm('Si esta todo correcto Presione Aceptar');">
    </font></div></td>
    <td><div align="right">Observaciones</div></td>
    <td><strong><font color="#000000" size="2">
      <input name="motivo" type="text" id="motivo"onKeyPress="return verif_caracter(this,event)" value="<?php echo $observaciones;?>"  size="50" maxlength="50" tabindex="28">
    </font></strong></td>
  <tr>
    <td height="0"></td>
    <td colspan="2"></td>
