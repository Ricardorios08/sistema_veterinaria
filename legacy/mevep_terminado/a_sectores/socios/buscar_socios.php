...
<?php }?>
	...
	<tr bgcolor="#EBEBEB">
	  ...
	  <td valign="top"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS"><a href="../hc/entrada_hc.php?cod_socio=<?php print("$cod_socio");?>">HISTORIA CLINICA</a> - <a href="../hc/entrada_hc_imprimir.php?cod_socio=<?php print("$cod_socio");?>">IMPRIMIR</a></font></strong></div></td>
...
$id=strtoupper($result1->fields["id"]);


?>
       
        <tr bgcolor="#EBEBEB">
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS"><a href="borrar_masota.php?id=<?php print("$id");?>&&cod_socio=<?php print("$cod_socio");?>&&cod_animal=<?php print("$cod_animal");?>" onClick="return confirm('&iquest;Est&aacute; seguro de Borrar la mascota con toda su historia Clinica?');"><img src="../../imagenes/office//1047.ico" alt="Borrar" border = "0"></a> NOMBRE</font></div></td>
          <td bgcolor="#F0F0F0"><div align="center" class="Estilo4">
            <div align="left"><font face="Trebuchet MS">&nbsp;&nbsp;<a href="modificar_mascota.php?id=<?php print("$id");?>&&cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong></strong></a><a href="modificar_mascota.php?id=<?php print("$id");?>&&cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong><?php print("$nombre");?></strong></a></font></div>
          </div>          </td>
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS">TAMA&Ntilde;O</font></div></td>
          <td colspan="2" ><div align="left"><font face="Trebuchet MS">&nbsp;&nbsp;<a href="modificar_mascota.php?id=<?php print("$id");?>&&cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong></strong></a></font><font size="2" face="Trebuchet MS"><?php print("$tamanio");?></font></div></td>
        </tr>
        <tr bgcolor="#EBEBEB">
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS">ESPECIE</font></div></td>
          <td><div align="left"><font face="Trebuchet MS">&nbsp;&nbsp;<a href="modificar_mascota.php?id=<?php print("$id");?>&&cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong></strong></a></font><font size="2" face="Trebuchet MS"><?php print("$especie");?></font></div></td>
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS">COLOR</font></div></td>
          <td colspan="2" valign="top"><div align="left"><font face="Trebuchet MS">&nbsp;&nbsp;<a href="modificar_mascota.php?id=<?php print("$id");?>&&cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong></strong></a></font><font size="2" face="Trebuchet MS"><?php print("$color");?></font></div></td>
        </tr>
        <tr bgcolor="#EBEBEB">
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS">RAZA</font></div></td>
          <td><div align="left"><font face="Trebuchet MS">&nbsp;&nbsp;<a href="modificar_mascota.php?id=<?php print("$id");?>&&cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong></strong></a></font><font size="2" face="Trebuchet MS"><?php print("$raza");?></font></div></td>
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS">SEXO</font></div></td>
          <td colspan="2" valign="top"><div align="left"><font face="Trebuchet MS">&nbsp;&nbsp;<a href="modificar_mascota.php?id=<?php print("$id");?>&&cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong></strong></a></font><font size="2" face="Trebuchet MS"><?php print("$sexo");?></font></div></td>
        </tr>
        <tr bgcolor="#EBEBEB">
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS">PELAJE</font></div></td>
          <td><div align="left"><font face="Trebuchet MS">&nbsp;&nbsp;<a href="modificar_mascota.php?id=<?php print("$id");?>&&cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong></strong></a></font><font size="2" face="Trebuchet MS"><?php print("$pelaje");?></font></div></td>
          <td bgcolor="#CCCCCC"><div align="right"><font size="2" face="Trebuchet MS">FECHA NAC</font></div></td>
          <td colspan="2" valign="top"><div align="left"><font face="Trebuchet MS">&nbsp;&nbsp;<a href="modificar_mascota.php?id=<?php print("$id");?>&&cod_animal=<?php print("$cod_animal");?>&&cod_socio=<?php print("$cod_socio");?>"><strong></strong></a></font><font size="2" face="Trebuchet MS"><?php print("$fecha_nac");?></font></div></td>
        </tr>
        <?php 
