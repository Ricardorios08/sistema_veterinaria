...
$cod_cobrador=$_REQUEST["cod_cobrador"];
  ...
  $sql11="select *  from cobradores where cod_cobrador = $cod_cobrador";
$result11 = $db->Execute($sql11);

$nombre_cobrador=$result11->fields["nombre_cobrador"];
$plan=$result11->fields["plan"];
...
<table width="850" border="0" cellspacing="0">
    ...
    <tr bordercolor="#FFFFFF">
      <td height="30" colspan="2" bgcolor="#CCCCCC"><div align="center"><strong>MODIFICAR COBRADOR </strong></div></td>
  </tr>
    ...
    <tr bordercolor="#FFFFFF">
      ...
      <td width="281"> <font color="#000000" size="2">
        <input name="nombre_cobrador" type="text" id="nombre_cobrador" onKeyPress="return verif_caracter(this,event)" value="<?php echo $nombre_cobrador;?>" size="40" maxlength="60" tabindex="3">
      </font></td>
  <tr bordercolor="#FFFFFF">
...
?>   <optgroup label = "Opcion Seleccionada">
          <option value selected = "<?php print("$plan");?>"><font color="#000000" size="2"><?php print("$plan");?></font></option>
          </optgroup>
<?php 
...
?>
  ...
  <tr bordercolor="#FFFFFF">
    <td height="26" colspan="2"><div align="center"><font color="#000000" size="2">
               <input type="hidden" name="cod_cobrador" value="<?php echo $cod_cobrador;?>">
