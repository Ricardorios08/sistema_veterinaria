...
<form action="guardar_hc.php" method="post">
<table width="850" border="1" cellspacing="0">
  ...
  <tr bgcolor="#FFFFCC">
    <td colspan="5"><span class="Estilo4">SOCIO: <?php echo $cod_socio;?> - <?php echo $apellido;?>, <?php echo $nombre;?></span></td>
  </tr>
...
$hora=strtoupper($result1->fields["hora"]);
?>

  <tr bordercolor="#000000" bgcolor="#FFFFFF">
    <td width="124"><div align="center" class="Estilo2 Estilo3"><?php echo $fecha_diagnostico;?> <?php echo $hora;?></div></td>
    <td colspan="3" valign="top"><div align="center" class="Estilo4">
        <div align="left"><strong><?php echo $diagnostico_presuntivo;?></strong></div>
    </div></td>
    <td valign="top"><div align="center" class="Estilo4"><?php echo $nombre_vet;?></div></td>
  </tr>
  <tr bordercolor="#000000" bgcolor="#FFFFFF">
    <td><div align="center"><span class="Estilo4">&nbsp;&nbsp;<a href="modi_hc.php?cod_operacion=<?php print("$cod_operacion");?>&&cod_socio=<?php print("$cod_socio");?>&&tipo=<?php print("$tipo");?>" class="Estilo5">Modificar HC </a>
	
	<br>	<br>
	
	<a href="borrar_hc.php?cod_operacion=<?php print("$cod_operacion");?>&&cod_socio=<?php print("$cod_socio");?>&&tipo=<?php print("$tipo");?>" class="Estilo5">Borrar renglón </a>
	
	</span></div></td>
    <td colspan="4"><span class="Estilo4"><?php echo $diagnostico;?></span></td>
  </tr>
...
<table width="850" border="0" cellspacing="0">
  <tr bgcolor="#CCCCCC">
    <td height="36" colspan="2"><div align="center" class="Estilo1">MODIFICAR DIAGNOSTICO</div></td>
  </tr>
  <tr>
  ...
  <tr bgcolor="#EBEBEB">
    <td colspan="2"><div align="center"><span class="Estilo4">
          <textarea name="diagnostico" cols="120" rows="10" id="textarea"></textarea>
    </span></div></td>
  </tr>
  <tr bgcolor="#CCCCCC">
