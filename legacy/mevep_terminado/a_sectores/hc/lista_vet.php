...
?>
 ...
 <?PHP  if ($cont == "1"){?>
  <tr bgcolor="#66FF99">
    ...
    <td><div align="center" class="Estilo12"><span class="Estilo4"><a href="../hc/entrada_hc1_vet.php?cod_socio=<?php print("$cod_socio");?>&&cod_operacion=<?php print("$cod_operacion");?>&&usuario=<?php print("$usuario");?>&&tipo=<?php print("$tipo");?>"  target ="central"> <img src="../../imagenes/office//1274.ico" alt="Borrar" border = "0"></a></span></div></td>
