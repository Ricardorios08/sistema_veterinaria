...
$tipo= $_REQUEST['tipo'];
   ...
   $sql = "UPDATE `lista_espera` SET `atendido` = 'S' WHERE `cod_operacion` = '$cod_operacion'";
mysql_query($sql);
...
<form action="guardar_hc1_vet.php" method="post">
<table width="650" border="0" cellspacing="0">
  <tr bgcolor="#FFFFFF">
    <td height="36" colspan="4"><div align="left"><span class="Estilo5">NOMBRE VETERINARIO: <?php echo $nombre_vet;?></span></div></td>
  </tr>
  <tr bgcolor="#FF0000">
  ...
  <tr bgcolor="#FF0000">
    <td height="23" colspan="4"><div align="center"><span class="Estilo7">DIAGNOSTICOS ANTERIORES</span></div></td>
  </tr>
...
<table width="650" border="0" cellspacing="0">
  <tr bgcolor="#FF0000">
    <td height="23" colspan="2"><div align="center" class="Estilo7">NUEVO DIAGNOSTICO</div></td>
  </tr>
  <tr>
    <td width="109" height="54" bgcolor="#EBEBEB"><div align="center" class="Estilo2 Estilo3"><strong>FECHA:</strong> <?php echo $hoy;?></div></td>
    <td width="737" bgcolor="#EBEBEB"><div align="center" class="Estilo4">
      <div align="left"><strong>DIAGNOSTICO PRESUNTIVO: </strong>
          <input name="diagnostico_presuntivo" type="text" id="diagnostico_presuntivo" size="65">
      </div>
    </div></td>
  </tr>
  <tr bgcolor="#EBEBEB">
    <td colspan="2"><div align="center"><span class="Estilo4">&nbsp;&nbsp;
          <textarea name="diagnostico" cols="100" rows="5" id="textarea"></textarea>
</span></div></td>
  </tr>
  <tr bgcolor="#CCCCCC">
