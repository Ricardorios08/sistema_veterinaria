...
$cod_barra = $cod_socio.$mes1.$anio.$importe_cuota_barra.$cobrador;
...
$importe_cuota_barra1=strtoupper($result2->fields["importe_cuota"]);
...
list($precio_entero1,$precio_decimal1) = explode(".",$importe_cuota_barra1);
if (strlen($precio_decimal1) == 1){
$precio_decimal1 = $precio_decimal1."0";
}
$importe_cuota_barra1 = $precio_entero1."".$precio_decimal1;




if (strlen($importe_cuota_barra1) == 4){
$importe_cuota_barra1 = "0".$importe_cuota_barra1;
}
$cod_barra = $cod_socio.$mes1.$anio.$importe_cuota_barra1.$cobrador;
...
//$pdf->Code39(10,250,$cod_barra,1,10);
//$pdf->Code39(130,180,$cod_barra,1,10);
