...
<TABLE width="981">
<TR>
	<TD width="36" bgcolor="#CCCCCC"><div align="center" class="Estilo2">RUTA</div></TD>
	<TD width="65" bgcolor="#CCCCCC"><div align="center"><span class="Estilo2">COD SOCIO</span></div></TD>
	<TD width="211" bgcolor="#CCCCCC"><div align="center" class="Estilo2">SOCIO</div>	  <div align="center" class="Estilo2"></div></TD>
	<TD width="328" bgcolor="#CCCCCC"><div align="center" class="Estilo2">OBSERVACIONES</div></TD>
			<TD width="114" bgcolor="#CCCCCC"><div align="center" class="Estilo2">COBRADOR</div></TD>
						<TD width="171" bgcolor="#CCCCCC"><div align="center" class="Estilo2">TELEFONO</div></TD>
</TR>

<?php
include("../../conexiones/config.inc.php");

$sql = "SELECT * FROM `socios` WHERE no_imprimir = 'VERDADERO' order by ruta";
...
<TR>
	...
	<TD><div align="left" class="Estilo3"><span class="Estilo4"> <?php print("$apellido");?>, <?php print("$nombre");?></a> </TD>
	<TD><div align="left" class="Estilo3"><span class="Estilo2"><?php echo $motivo;?></span></div></TD>
	<TD><div align="left" class="Estilo3"><span class="Estilo4"><?php echo $cobrador1;?></span></div></TD>
