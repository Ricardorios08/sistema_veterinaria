...
<table width="800" border="0" cellspacing="0">
  ...
  <tr bordercolor="#FFFFCC" bgcolor="#CCCCCC">
    ...
    <td><div align="left"><strong><font color="#000000" size="2" face="Trebuchet MS">COBRADOR: </font></strong><strong><font size="2" face="Trebuchet MS"><?php echo $cobrador;?></font></strong></div>      </td>
...
$sql1="select * from pagos where cobrador = $cod_cobrador and mes = $mes and anio = $anio and estado = 'PAGADO'";
