...
$cod_plan=$_REQUEST["cod_plan"];
 ...
 echo  $sql11="select *  from plan_cobrador where cod_plan = $cod_plan";
$result11 = $db->Execute($sql11);

$a1_10=$result11->fields["1_10"];
$a11_20=$result11->fields["11_20"];
$a21_31=$result11->fields["21_31"];
$deuda=$result11->fields["deuda"];
...
<table width="850" border="0" cellspacing="0">
    ...
    <tr bordercolor="#FFFFFF">
      <td height="30" colspan="2" bgcolor="#CCCCCC"><div align="center"><strong>MODIFICAR PLAN </strong></div></td>
  </tr>
  ...
  <tr bordercolor="#FFFFFF">
    <td height="26" colspan="2"><div align="center"><font color="#000000" size="2">
        <input name="cod_plan" type="hidden" id="cod_plan"onKeyPress="return verif_caracter(this,event)" value="<?php echo $cod_plan;?>" size="3" maxlength="3" tabindex="3">
