...
$nro_boleta=$result->fields["nro_boleta"];
 ...
 $sql="select * from pagos where anio = '$anio' and mes = '$mes' and tipo_creacion = 0";
 $result = $db->Execute($sql);
...
$nro_boleta = $nro_boleta + 1;
 ...
 $sql="select * from pagos where cod_socio = '$cod_socio' and anio = '$anio' and mes = '$mes'";
...
?>
 ...
 <td><?php echo $cod_socio; ?></td>
                      <td><?php echo $socio; ?></td>
                        ...
                        <td><?php echo $mes; ?></td>
                        <td><?php echo $anio; ?></td>
                        <td><?php echo $importe_cuota; ?></td>
                    </tr>
	<?php

 $sql = "INSERT INTO `pagos` ( `cod_socio` , `mes` , `anio` , `importe` , `cobrador` , `observaciones` , `estado` ,`fecha_generacion` ,   `fecha_pago` ,  `nro_boleta` , `socio` , `hora` , `tipo_creacion`)  VALUES ( '$cod_socio' , '$mes' , '$anio' , '$importe_cuota' , '$cobrador' , '$observaciones' , 'PENDIENTE' ,  '$fecha_generacion'  , '' , '$nro_boleta' , '$socio' , '' , '0')";
 mysql_query($sql);
