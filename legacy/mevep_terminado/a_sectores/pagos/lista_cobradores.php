...
?>
<table width="391" border="0" cellspacing="0">
  <!--DWLayoutTable-->
  
  <tr bordercolor="#FFFFCC" bgcolor="#CCCCCC">
  
    <td width="94"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS">COD </font></strong></div></td>
    <td width="293"><div align="center"><strong><font color="#000000" size="2" face="Trebuchet MS"> NOMBRE COBRADOR </font></strong></div></td>
    <?php 
